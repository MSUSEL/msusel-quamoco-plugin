...
public class Java8Lexer extends Lexer {
	...
	public static final Vocabulary VOCABULARY = new VocabularyImpl(Java8Lexer._LITERAL_NAMES,
	...
	static {
		tokenNames = new String[Java8Lexer._SYMBOLIC_NAMES.length];
		for (int i = 0; i < Java8Lexer.tokenNames.length; i++) {
			Java8Lexer.tokenNames[i] = Java8Lexer.VOCABULARY.getLiteralName(i);
			if (Java8Lexer.tokenNames[i] == null) {
				Java8Lexer.tokenNames[i] = Java8Lexer.VOCABULARY.getSymbolicName(i);
			}

			if (Java8Lexer.tokenNames[i] == null) {
				Java8Lexer.tokenNames[i] = "<INVALID>";
			}
		}
	}
	...
	public Java8Lexer(final CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this, Java8Lexer._ATN, Java8Lexer._decisionToDFA,
				Java8Lexer._sharedContextCache);
	}
	...
	public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\2m\u0448\b\1\4\2\t"
			...
			+ "\u0332\u033d\u0341\u0346\u034a\u035a\u0364\u036a\u0371\u0375\u037b\u0388"
			+ "\u040f\u0418\u0420\u042b\u0435\u0443\3\b\2\2";
	public static final ATN _ATN = new ATNDeserializer().deserialize(Java8Lexer._serializedATN.toCharArray());

	static {
		_decisionToDFA = new DFA[Java8Lexer._ATN.getNumberOfDecisions()];
		for (int i = 0; i < Java8Lexer._ATN.getNumberOfDecisions(); i++) {
			Java8Lexer._decisionToDFA[i] = new DFA(Java8Lexer._ATN.getDecisionState(i), i);
		}
	}
}