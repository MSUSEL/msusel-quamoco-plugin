...
public class CSharp5PreProcessor extends Lexer {
	...
	public static final int Pp_directive = 1, BYTE_ORDER_MARK = 2, SINGLE_LINE_DOC_COMMENT = 3,
			DELIMITED_DOC_COMMENT = 4, NEW_LINE = 5, SINGLE_LINE_COMMENT = 6, DELIMITED_COMMENT = 7, WHITESPACE = 8,
			ABSTRACT = 9, ADD = 10, ALIAS = 11, ARGLIST = 12, AS = 13, ASCENDING = 14, ASYNC = 15, AWAIT = 16,
			BASE = 17, BOOL = 18, BREAK = 19, BY = 20, BYTE = 21, CASE = 22, CATCH = 23, CHAR = 24, CHECKED = 25,
			CLASS = 26, CONST = 27, CONTINUE = 28, DECIMAL = 29, DEFAULT = 30, DELEGATE = 31, DESCENDING = 32, DO = 33,
			DOUBLE = 34, DYNAMIC = 35, ELSE = 36, ENUM = 37, EQUALS = 38, EVENT = 39, EXPLICIT = 40, EXTERN = 41,
			FALSE = 42, FINALLY = 43, FIXED = 44, FLOAT = 45, FOR = 46, FOREACH = 47, FROM = 48, GET = 49, GOTO = 50,
			GROUP = 51, IF = 52, IMPLICIT = 53, IN = 54, INT = 55, INTERFACE = 56, INTERNAL = 57, INTO = 58, IS = 59,
			JOIN = 60, LET = 61, LOCK = 62, LONG = 63, NAMESPACE = 64, NEW = 65, NULL = 66, OBJECT = 67, ON = 68,
			OPERATOR = 69, ORDERBY = 70, OUT = 71, OVERRIDE = 72, PARAMS = 73, PARTIAL = 74, PRIVATE = 75,
			PROTECTED = 76, PUBLIC = 77, READONLY = 78, REF = 79, REMOVE = 80, RETURN = 81, SBYTE = 82, SEALED = 83,
			SELECT = 84, SET = 85, SHORT = 86, SIZEOF = 87, STACKALLOC = 88, STATIC = 89, STRING = 90, STRUCT = 91,
			SWITCH = 92, THIS = 93, THROW = 94, TRUE = 95, TRY = 96, TYPEOF = 97, UINT = 98, ULONG = 99,
			UNCHECKED = 100, UNSAFE = 101, USHORT = 102, USING = 103, VIRTUAL = 104, VOID = 105, VOLATILE = 106,
			WHERE = 107, WHILE = 108, YIELD = 109, IDENTIFIER = 110, INTEGER_LITERAL = 111, LiteralAccess = 112,
			REAL_LITERAL = 113, CHARACTER_LITERAL = 114, STRING_LITERAL = 115, OPEN_BRACE = 116, CLOSE_BRACE = 117,
			OPEN_BRACKET = 118, CLOSE_BRACKET = 119, OPEN_PARENS = 120, CLOSE_PARENS = 121, DOT = 122, COMMA = 123,
			COLON = 124, SEMICOLON = 125, PLUS = 126, MINUS = 127, STAR = 128, DIV = 129, PERCENT = 130, AMP = 131,
			BITWISE_OR = 132, CARET = 133, BANG = 134, TILDE = 135, ASSIGNMENT = 136, LT = 137, GT = 138, INTERR = 139,
			DOUBLE_COLON = 140, OP_COALESCING = 141, OP_INC = 142, OP_DEC = 143, OP_AND = 144, OP_OR = 145,
			OP_PTR = 146, OP_EQ = 147, OP_NE = 148, OP_LE = 149, OP_GE = 150, OP_ADD_ASSIGNMENT = 151,
			OP_SUB_ASSIGNMENT = 152, OP_MULT_ASSIGNMENT = 153, OP_DIV_ASSIGNMENT = 154, OP_MOD_ASSIGNMENT = 155,
			OP_AND_ASSIGNMENT = 156, OP_OR_ASSIGNMENT = 157, OP_XOR_ASSIGNMENT = 158, OP_LEFT_SHIFT = 159,
			OP_LEFT_SHIFT_ASSIGNMENT = 160, QUOTE = 161, DOUBLE_QUOTE = 162, BACK_SLASH = 163, DOUBLE_BACK_SLASH = 164,
			SHARP = 165;
	public static String[] modeNames = { "DEFAULT_MODE" };

	public static final String[] ruleNames = { "Pp_directive", "Pp_expression", "Pp_or_expression", "Pp_and_expression",
			"Pp_equality_expression", "Pp_unary_expression", "Pp_primary_expression", "Pp_declaration", "Pp_new_line",
			"Pp_conditional", "Pp_if_section", "Pp_elif_section", "Pp_else_section", "Pp_endif", "Conditional_symbol",
			"Pp_diagnostic", "Pp_message", "Pp_region", "Pp_start_region", "Pp_end_region", "Pp_line", "Line_indicator",
			"File_name", "File_name_characters", "File_name_character", "Pp_pragma", "Pp_pragma_text",
			"SkiPped_section_part", "SkiPped_characters", "Not_number_sign", "BYTE_ORDER_MARK",
			"SINGLE_LINE_DOC_COMMENT", "DELIMITED_DOC_COMMENT", "NEW_LINE", "SINGLE_LINE_COMMENT", "Input_characters",
			"Input_character", "NEW_LINE_CHARACTER", "DELIMITED_COMMENT", "Delimited_comment_section", "Asterisks",
	...
	private static final String[] _LITERAL_NAMES = { null, null, "'\\u00EF\\u00BB\\u00BF'", null, null, null, null,
			null, null, "'abstract'", "'add'", "'alias'", "'__arglist'", "'as'", "'ascending'", "'async'", "'await'",
			"'base'", "'bool'", "'break'", "'by'", "'byte'", "'case'", "'catch'", "'char'", "'checked'", "'class'",
			"'const'", "'continue'", "'decimal'", "'default'", "'delegate'", "'descending'", "'do'", "'double'",
			"'dynamic'", "'else'", "'enum'", "'equals'", "'event'", "'explicit'", "'extern'", "'false'", "'finally'",
			"'fixed'", "'float'", "'for'", "'foreach'", "'from'", "'get'", "'goto'", "'group'", "'if'", "'implicit'",
			...
			"'unchecked'", "'unsafe'", "'ushort'", "'using'", "'virtual'", "'void'", "'volatile'", "'where'", "'while'",
	...
	public static final Vocabulary VOCABULARY = new VocabularyImpl(CSharp5PreProcessor._LITERAL_NAMES,
			CSharp5PreProcessor._SYMBOLIC_NAMES);
	...
	static {
		tokenNames = new String[CSharp5PreProcessor._SYMBOLIC_NAMES.length];
		for (int i = 0; i < CSharp5PreProcessor.tokenNames.length; i++) {
			CSharp5PreProcessor.tokenNames[i] = CSharp5PreProcessor.VOCABULARY.getLiteralName(i);
			if (CSharp5PreProcessor.tokenNames[i] == null) {
				CSharp5PreProcessor.tokenNames[i] = CSharp5PreProcessor.VOCABULARY.getSymbolicName(i);
			}

			if (CSharp5PreProcessor.tokenNames[i] == null) {
				CSharp5PreProcessor.tokenNames[i] = "<INVALID>";
			}
		}
	}
	...
	public String[] getTokenNames() {
		return CSharp5PreProcessor.tokenNames;
	}

	@Override

	public Vocabulary getVocabulary() {
		return CSharp5PreProcessor.VOCABULARY;
	}

	public CSharp5PreProcessor(final CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this, CSharp5PreProcessor._ATN, CSharp5PreProcessor._decisionToDFA,
				CSharp5PreProcessor._sharedContextCache);
	}
	...
	public String[] getRuleNames() {
		return CSharp5PreProcessor.ruleNames;
	}

	@Override
	public String getSerializedATN() {
		return CSharp5PreProcessor._serializedATN;
	}

	@Override
	public String[] getModeNames() {
		return CSharp5PreProcessor.modeNames;
	}

	@Override
	public ATN getATN() {
		return CSharp5PreProcessor._ATN;
	}
	...
	public static final ATN _ATN = new ATNDeserializer().deserialize(CSharp5PreProcessor._serializedATN.toCharArray());

	static {
		_decisionToDFA = new DFA[CSharp5PreProcessor._ATN.getNumberOfDecisions()];
		for (int i = 0; i < CSharp5PreProcessor._ATN.getNumberOfDecisions(); i++) {
			CSharp5PreProcessor._decisionToDFA[i] = new DFA(CSharp5PreProcessor._ATN.getDecisionState(i), i);
		}
	}
}