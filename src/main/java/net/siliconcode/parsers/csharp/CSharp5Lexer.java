...
public class CSharp5Lexer extends Lexer {
	...
	public static final Vocabulary VOCABULARY = new VocabularyImpl(CSharp5Lexer._LITERAL_NAMES,
			CSharp5Lexer._SYMBOLIC_NAMES);
	...
	static {
		tokenNames = new String[CSharp5Lexer._SYMBOLIC_NAMES.length];
		for (int i = 0; i < CSharp5Lexer.tokenNames.length; i++) {
			CSharp5Lexer.tokenNames[i] = CSharp5Lexer.VOCABULARY.getLiteralName(i);
			if (CSharp5Lexer.tokenNames[i] == null) {
				CSharp5Lexer.tokenNames[i] = CSharp5Lexer.VOCABULARY.getSymbolicName(i);
			}

			if (CSharp5Lexer.tokenNames[i] == null) {
				CSharp5Lexer.tokenNames[i] = "<INVALID>";
			}
		}
	}
	...
	public String[] getTokenNames() {
		return CSharp5Lexer.tokenNames;
	}

	@Override

	public Vocabulary getVocabulary() {
		return CSharp5Lexer.VOCABULARY;
	}

	public CSharp5Lexer(final CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this, CSharp5Lexer._ATN, CSharp5Lexer._decisionToDFA,
				CSharp5Lexer._sharedContextCache);
	}
	...
	public String[] getRuleNames() {
		return CSharp5Lexer.ruleNames;
	}

	@Override
	public String getSerializedATN() {
		return CSharp5Lexer._serializedATN;
	}

	@Override
	public String[] getModeNames() {
		return CSharp5Lexer.modeNames;
	}

	@Override
	public ATN getATN() {
		return CSharp5Lexer._ATN;
	}
	...
	public static final ATN _ATN = new ATNDeserializer().deserialize(CSharp5Lexer._serializedATN.toCharArray());

	static {
		_decisionToDFA = new DFA[CSharp5Lexer._ATN.getNumberOfDecisions()];
		for (int i = 0; i < CSharp5Lexer._ATN.getNumberOfDecisions(); i++) {
			CSharp5Lexer._decisionToDFA[i] = new DFA(CSharp5Lexer._ATN.getDecisionState(i), i);
		}
	}
}