...
public class CSharp6Lexer extends Lexer {
    ...
    public static final String[]                  ruleNames           = { "Pp_directive", "Pp_expression",
            ...
            "LOCK", "LONG", "NAMEOF", "NAMESPACE", "NEW", "NULL", "OBJECT", "ON", "OPERATOR", "ORDERBY", "OUT",
            ...
            "VIRTUAL", "VOID", "VOLATILE", "WHEN", "WHERE", "WHILE", "YIELD", "IDENTIFIER", "Available_identifier",
            ...
            "Hexadecimal_escape_sequence", "STRING_LITERAL", "Interpolation_string_literal",
            "Interpolation_string_literal_character", "Single_interpolation_string_literal_character",
            "Interpolation_expr_literal_character", "Regular_string_literal", "Regular_string_literal_character",
            "Single_regular_string_literal_character", "Verbatim_string_literal", "Verbatim_string_literal_character",
            "Single_verbatim_string_literal_character", "Quote_escape_sequence", "OPEN_BRACE", "CLOSE_BRACE",
            "OPEN_BRACKET", "CLOSE_BRACKET", "OPEN_PARENS", "CLOSE_PARENS", "DOT", "COMMA", "COLON", "SEMICOLON",
            "PLUS", "MINUS", "STAR", "DIV", "PERCENT", "AMP", "BITWISE_OR", "CARET", "BANG", "TILDE", "ASSIGNMENT",
            "LT", "GT", "INTERR", "DOUBLE_COLON", "OP_COALESCING", "OP_INC", "OP_DEC", "OP_AND", "OP_OR", "OP_PTR",
            "OP_EQ", "OP_NE", "OP_LE", "OP_GE", "OP_ADD_ASSIGNMENT", "OP_SUB_ASSIGNMENT", "OP_MULT_ASSIGNMENT",
            "OP_DIV_ASSIGNMENT", "OP_MOD_ASSIGNMENT", "OP_AND_ASSIGNMENT", "OP_OR_ASSIGNMENT", "OP_XOR_ASSIGNMENT",
            "OP_LEFT_SHIFT", "OP_LEFT_SHIFT_ASSIGNMENT", "OP_STRING_INTERP", "QUOTE", "DOUBLE_QUOTE", "BACK_SLASH",
    ...
    public CSharp6Lexer(CharStream input)
    {
        super(input);
