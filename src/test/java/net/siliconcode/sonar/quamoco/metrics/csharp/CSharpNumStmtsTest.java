...
/**
 * The class <code>CSharpNumStmtsTest</code> contains tests for the class <code>{@link CSharpNumStmts}</code>.
 *
 * @generatedBy CodePro at 5/30/15 3:48 PM
 * @author isaac
 * @version $Revision: 1.0 $
 */
public class CSharpNumStmtsTest {
    /**
     * Run the Measure<Double> getTotalNOS(MetricContext) method test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 5/30/15 3:48 PM
        ...
        throws Exception
    {
        ...
        Measure<Double> result = CSharpNumStmts.getTotalNOS(metctx);

        // TODO: add additional test code here
        assertNotNull(result);
        assertEquals(null, result.getVariation5());
        assertEquals("quamoco.cs.file/CountStmt", result.getMetricKey());
    ...
    {
        new org.junit.runner.JUnitCore().run(CSharpNumStmtsTest.class);
    }
}