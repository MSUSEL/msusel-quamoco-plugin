...
/**
 * The class <code>GradeThresholdExceptionTest</code> contains tests for the class <code>{@link GradeThresholdException}</code>.
 *
...
public class GradeThresholdExceptionTest {
        ...
        throws Exception
    {
        ...
        // TODO: add additional test code here
        assertNotNull(result);
        assertEquals("net.siliconcode.quamoco.aggregator.GradeThresholdException: java.lang.Throwable", result.toString());
    ...
    /**
     * Run the GradeThresholdException(String,Throwable,boolean,boolean) constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 5/30/15 3:42 PM
        ...
        throws Exception
    {
        ...
        GradeThresholdException result = new GradeThresholdException(message, cause, enableSuppression, writableStackTrace);
