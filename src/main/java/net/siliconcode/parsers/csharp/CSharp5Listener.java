...
public interface CSharp5Listener extends ParseTreeListener {
	 ...
	 *            the parse tree
	 */
	void enterExplicit_anonymous_function_parameter_list(
	 ...
	 *            the parse tree
	 */
	void exitExplicit_anonymous_function_parameter_list(
			CSharp5Parser.Explicit_anonymous_function_parameter_listContext ctx);
	 ...
	 *            the parse tree
	 */
	void enterImplicit_anonymous_function_parameter_list(
	 ...
	 *            the parse tree
	 */
	void exitImplicit_anonymous_function_parameter_list(
			CSharp5Parser.Implicit_anonymous_function_parameter_listContext ctx);
	 ...
	 *            the parse tree
	 */
	void enterPrimary_no_array_creation_expression_unsafe(
	 ...
	 *            the parse tree
	 */
	void exitPrimary_no_array_creation_expression_unsafe(
			CSharp5Parser.Primary_no_array_creation_expression_unsafeContext ctx);
