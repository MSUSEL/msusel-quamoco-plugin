...
/**
 * The class <code>JavaNumStmtsTest</code> contains tests for the class <code>{@link JavaNumStmts}</code>.
 *
...
public class JavaNumStmtsTest {
    ...
    {
        new org.junit.runner.JUnitCore().run(JavaNumStmtsTest.class);
    }
}