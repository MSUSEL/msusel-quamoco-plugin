...
package net.siliconcode.parsers.java;
...
public class Java8Parser extends Parser {
	...
	public static final int ABSTRACT = 1, ASSERT = 2, BOOLEAN = 3, BREAK = 4, BYTE = 5, CASE = 6, CATCH = 7, CHAR = 8,
			...
			LINE_COMMENT = 107;
	public static final int RULE_literal = 0, RULE_type = 1, RULE_primitiveType = 2, RULE_numericType = 3,
			RULE_integralType = 4, RULE_floatingPointType = 5, RULE_referenceType = 6, RULE_classOrInterfaceType = 7,
			...
			RULE_typeParameterModifier = 18, RULE_typeBound = 19, RULE_additionalBound = 20, RULE_typeArguments = 21,
			RULE_typeArgumentList = 22, RULE_typeArgument = 23, RULE_wildcard = 24, RULE_wildcardBounds = 25,
			RULE_packageName = 26, RULE_typeName = 27, RULE_packageOrTypeName = 28, RULE_expressionName = 29,
			RULE_methodName = 30, RULE_ambiguousName = 31, RULE_compilationUnit = 32, RULE_packageDeclaration = 33,
			...
			RULE_staticImportOnDemandDeclaration = 39, RULE_typeDeclaration = 40, RULE_classDeclaration = 41,
			RULE_normalClassDeclaration = 42, RULE_classModifier = 43, RULE_typeParameters = 44,
			RULE_typeParameterList = 45, RULE_superclass = 46, RULE_superinterfaces = 47, RULE_interfaceTypeList = 48,
			...
			RULE_variableDeclarator = 55, RULE_variableDeclaratorId = 56, RULE_variableInitializer = 57,
			RULE_unannType = 58, RULE_unannPrimitiveType = 59, RULE_unannReferenceType = 60,
			...
			RULE_unannArrayType = 69, RULE_methodDeclaration = 70, RULE_methodModifier = 71, RULE_methodHeader = 72,
			RULE_result = 73, RULE_methodDeclarator = 74, RULE_formalParameterList = 75, RULE_formalParameters = 76,
			RULE_formalParameter = 77, RULE_variableModifier = 78, RULE_lastFormalParameter = 79,
			RULE_receiverParameter = 80, RULE_throws_ = 81, RULE_exceptionTypeList = 82, RULE_exceptionType = 83,
			...
			RULE_enumDeclaration = 93, RULE_enumBody = 94, RULE_enumConstantList = 95, RULE_enumConstant = 96,
			RULE_enumConstantModifier = 97, RULE_enumBodyDeclarations = 98, RULE_interfaceDeclaration = 99,
			RULE_normalInterfaceDeclaration = 100, RULE_interfaceModifier = 101, RULE_extendsInterfaces = 102,
			RULE_interfaceBody = 103, RULE_interfaceMemberDeclaration = 104, RULE_constantDeclaration = 105,
			...
			RULE_annotationTypeElementModifier = 113, RULE_defaultValue = 114, RULE_annotation = 115,
			RULE_normalAnnotation = 116, RULE_elementValuePairList = 117, RULE_elementValuePair = 118,
			RULE_elementValue = 119, RULE_elementValueArrayInitializer = 120, RULE_elementValueList = 121,
			RULE_markerAnnotation = 122, RULE_singleElementAnnotation = 123, RULE_arrayInitializer = 124,
			RULE_variableInitializerList = 125, RULE_block = 126, RULE_blockStatements = 127, RULE_blockStatement = 128,
			RULE_localVariableDeclarationStatement = 129, RULE_localVariableDeclaration = 130, RULE_statement = 131,
			RULE_statementNoShortIf = 132, RULE_statementWithoutTrailingSubstatement = 133, RULE_emptyStatement = 134,
			...
			RULE_enhancedForStatement = 159, RULE_enhancedForStatementNoShortIf = 160, RULE_breakStatement = 161,
			RULE_continueStatement = 162, RULE_returnStatement = 163, RULE_throwStatement = 164,
			RULE_synchronizedStatement = 165, RULE_tryStatement = 166, RULE_catches = 167, RULE_catchClause = 168,
			RULE_catchFormalParameter = 169, RULE_catchType = 170, RULE_finally_ = 171,
			RULE_tryWithResourcesStatement = 172, RULE_resourceSpecification = 173, RULE_resourceList = 174,
			...
			RULE_methodInvocation_lfno_primary = 198, RULE_argumentList = 199, RULE_methodReference = 200,
			RULE_methodReference_lf_primary = 201, RULE_methodReference_lfno_primary = 202,
			RULE_arrayCreationExpression = 203, RULE_dimExprs = 204, RULE_dimExpr = 205, RULE_constantExpression = 206,
			...
			RULE_conditionalExpression = 216, RULE_conditionalOrExpression = 217, RULE_conditionalAndExpression = 218,
			RULE_inclusiveOrExpression = 219, RULE_exclusiveOrExpression = 220, RULE_andExpression = 221,
			RULE_equalityExpression = 222, RULE_relationalExpression = 223, RULE_shiftExpression = 224,
			RULE_additiveExpression = 225, RULE_multiplicativeExpression = 226, RULE_unaryExpression = 227,
			RULE_preIncrementExpression = 228, RULE_preDecrementExpression = 229,
			RULE_unaryExpressionNotPlusMinus = 230, RULE_postfixExpression = 231, RULE_postIncrementExpression = 232,
	...
	public static final String[] ruleNames = { "literal", "type", "primitiveType", "numericType", "integralType",
			"floatingPointType", "referenceType", "classOrInterfaceType", "classType",
			"classType_lf_classOrInterfaceType", "classType_lfno_classOrInterfaceType", "interfaceType",
			"interfaceType_lf_classOrInterfaceType", "interfaceType_lfno_classOrInterfaceType", "typeVariable",
			"arrayType", "dims", "typeParameter", "typeParameterModifier", "typeBound", "additionalBound",
			"typeArguments", "typeArgumentList", "typeArgument", "wildcard", "wildcardBounds", "packageName",
			"typeName", "packageOrTypeName", "expressionName", "methodName", "ambiguousName", "compilationUnit",
			...
			"typeDeclaration", "classDeclaration", "normalClassDeclaration", "classModifier", "typeParameters",
			"typeParameterList", "superclass", "superinterfaces", "interfaceTypeList", "classBody",
			"classBodyDeclaration", "classMemberDeclaration", "fieldDeclaration", "fieldModifier",
			"variableDeclaratorList", "variableDeclarator", "variableDeclaratorId", "variableInitializer", "unannType",
			"unannPrimitiveType", "unannReferenceType", "unannClassOrInterfaceType", "unannClassType",
			"unannClassType_lf_unannClassOrInterfaceType", "unannClassType_lfno_unannClassOrInterfaceType",
			"unannInterfaceType", "unannInterfaceType_lf_unannClassOrInterfaceType",
			"unannInterfaceType_lfno_unannClassOrInterfaceType", "unannTypeVariable", "unannArrayType",
			"methodDeclaration", "methodModifier", "methodHeader", "result", "methodDeclarator", "formalParameterList",
			"formalParameters", "formalParameter", "variableModifier", "lastFormalParameter", "receiverParameter",
			"throws_", "exceptionTypeList", "exceptionType", "methodBody", "instanceInitializer", "staticInitializer",
			"constructorDeclaration", "constructorModifier", "constructorDeclarator", "simpleTypeName",
			"constructorBody", "explicitConstructorInvocation", "enumDeclaration", "enumBody", "enumConstantList",
			"enumConstant", "enumConstantModifier", "enumBodyDeclarations", "interfaceDeclaration",
			"normalInterfaceDeclaration", "interfaceModifier", "extendsInterfaces", "interfaceBody",
			"interfaceMemberDeclaration", "constantDeclaration", "constantModifier", "interfaceMethodDeclaration",
			"interfaceMethodModifier", "annotationTypeDeclaration", "annotationTypeBody",
			"annotationTypeMemberDeclaration", "annotationTypeElementDeclaration", "annotationTypeElementModifier",
			"defaultValue", "annotation", "normalAnnotation", "elementValuePairList", "elementValuePair",
			"elementValue", "elementValueArrayInitializer", "elementValueList", "markerAnnotation",
			"singleElementAnnotation", "arrayInitializer", "variableInitializerList", "block", "blockStatements",
			"blockStatement", "localVariableDeclarationStatement", "localVariableDeclaration", "statement",
			"statementNoShortIf", "statementWithoutTrailingSubstatement", "emptyStatement", "labeledStatement",
			"labeledStatementNoShortIf", "expressionStatement", "statementExpression", "ifThenStatement",
			...
			"methodInvocation_lf_primary", "methodInvocation_lfno_primary", "argumentList", "methodReference",
			"methodReference_lf_primary", "methodReference_lfno_primary", "arrayCreationExpression", "dimExprs",
			...
			"postDecrementExpression", "postDecrementExpression_lf_postfixExpression", "castExpression" };
	...
	private static final String[] _SYMBOLIC_NAMES = { null, "ABSTRACT", "ASSERT", "BOOLEAN", "BREAK", "BYTE", "CASE",
			...
			"StringLiteral", "NullLiteral", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACK", "RBRACK", "SEMI", "COMMA",
			"DOT", "ASSIGN", "GT", "LT", "BANG", "TILDE", "QUESTION", "COLON", "EQUAL", "LE", "GE", "NOTEQUAL", "AND",
			"OR", "INC", "DEC", "ADD", "SUB", "MUL", "DIV", "BITAND", "BITOR", "CARET", "MOD", "ARROW", "COLONCOLON",
	...
	public static final Vocabulary VOCABULARY = new VocabularyImpl(Java8Parser._LITERAL_NAMES,
	...
	static {
		tokenNames = new String[Java8Parser._SYMBOLIC_NAMES.length];
		for (int i = 0; i < Java8Parser.tokenNames.length; i++) {
			Java8Parser.tokenNames[i] = Java8Parser.VOCABULARY.getLiteralName(i);
			if (Java8Parser.tokenNames[i] == null) {
				Java8Parser.tokenNames[i] = Java8Parser.VOCABULARY.getSymbolicName(i);
			}

			if (Java8Parser.tokenNames[i] == null) {
				Java8Parser.tokenNames[i] = "<INVALID>";
			}
		}
	}
	...
	@Override
	public ATN getATN() {
		return Java8Parser._ATN;
	}

	public Java8Parser(final TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this, Java8Parser._ATN, Java8Parser._decisionToDFA,
				Java8Parser._sharedContextCache);
	}
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		enterRule(_localctx, 0, Java8Parser.RULE_literal);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				if (!((_la & ~0x3f) == 0
						&& (1L << _la & (1L << Java8Parser.IntegerLiteral | 1L << Java8Parser.FloatingPointLiteral
								| 1L << Java8Parser.BooleanLiteral | 1L << Java8Parser.CharacterLiteral
								| 1L << Java8Parser.StringLiteral | 1L << Java8Parser.NullLiteral)) != 0)) {
	...
	public final TypeContext type() throws RecognitionException {
		...
		enterRule(_localctx, 2, Java8Parser.RULE_type);
		try {
			setState(478);
	...
	public static class PrimitiveTypeContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPrimitiveType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PrimitiveTypeContext primitiveType() throws RecognitionException {
		...
		enterRule(_localctx, 4, Java8Parser.RULE_primitiveType);
		int _la;
		try {
			setState(494);
	...
	public static class NumericTypeContext extends ParserRuleContext {
		...
		public NumericTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitNumericType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final NumericTypeContext numericType() throws RecognitionException {
		final NumericTypeContext _localctx = new NumericTypeContext(_ctx, getState());
		enterRule(_localctx, 6, Java8Parser.RULE_numericType);
		try {
			setState(498);
			switch (_input.LA(1)) {
			case BYTE:
	...
	public static class IntegralTypeContext extends ParserRuleContext {
		...
		public IntegralTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitIntegralType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final IntegralTypeContext integralType() throws RecognitionException {
		final IntegralTypeContext _localctx = new IntegralTypeContext(_ctx, getState());
		enterRule(_localctx, 8, Java8Parser.RULE_integralType);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(500);
				_la = _input.LA(1);
				if (!((_la & ~0x3f) == 0 && (1L << _la & (1L << Java8Parser.BYTE | 1L << Java8Parser.CHAR
						| 1L << Java8Parser.INT | 1L << Java8Parser.LONG | 1L << Java8Parser.SHORT)) != 0)) {
					_errHandler.recoverInline(this);
				} else {
					consume();
				}
	...
	public static class FloatingPointTypeContext extends ParserRuleContext {
		...
		public FloatingPointTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitFloatingPointType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final FloatingPointTypeContext floatingPointType() throws RecognitionException {
		final FloatingPointTypeContext _localctx = new FloatingPointTypeContext(_ctx, getState());
		enterRule(_localctx, 10, Java8Parser.RULE_floatingPointType);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ReferenceTypeContext extends ParserRuleContext {
		...
		public ReferenceTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitReferenceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ReferenceTypeContext referenceType() throws RecognitionException {
		final ReferenceTypeContext _localctx = new ReferenceTypeContext(_ctx, getState());
		enterRule(_localctx, 12, Java8Parser.RULE_referenceType);
		try {
			setState(507);
	...
	public static class ClassOrInterfaceTypeContext extends ParserRuleContext {
		...
		public ClassType_lf_classOrInterfaceTypeContext classType_lf_classOrInterfaceType(final int i) {
		...
		public InterfaceType_lf_classOrInterfaceTypeContext interfaceType_lf_classOrInterfaceType(final int i) {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitClassOrInterfaceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ClassOrInterfaceTypeContext classOrInterfaceType() throws RecognitionException {
		...
		enterRule(_localctx, 14, Java8Parser.RULE_classOrInterfaceType);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ClassTypeContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitClassType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ClassTypeContext classType() throws RecognitionException {
		...
		enterRule(_localctx, 16, Java8Parser.RULE_classType);
		int _la;
		try {
			setState(542);
	...
	public static class ClassType_lf_classOrInterfaceTypeContext extends ParserRuleContext {
		...
		public ClassType_lf_classOrInterfaceTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitClassType_lf_classOrInterfaceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ClassType_lf_classOrInterfaceTypeContext classType_lf_classOrInterfaceType()
		...
		final ClassType_lf_classOrInterfaceTypeContext _localctx = new ClassType_lf_classOrInterfaceTypeContext(_ctx,
				getState());
		enterRule(_localctx, 18, Java8Parser.RULE_classType_lf_classOrInterfaceType);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ClassType_lfno_classOrInterfaceTypeContext extends ParserRuleContext {
		...
		public ClassType_lfno_classOrInterfaceTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitClassType_lfno_classOrInterfaceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ClassType_lfno_classOrInterfaceTypeContext classType_lfno_classOrInterfaceType()
			throws RecognitionException {
		final ClassType_lfno_classOrInterfaceTypeContext _localctx = new ClassType_lfno_classOrInterfaceTypeContext(
				_ctx, getState());
		enterRule(_localctx, 20, Java8Parser.RULE_classType_lfno_classOrInterfaceType);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class InterfaceTypeContext extends ParserRuleContext {
		...
		public InterfaceTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInterfaceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final InterfaceTypeContext interfaceType() throws RecognitionException {
		final InterfaceTypeContext _localctx = new InterfaceTypeContext(_ctx, getState());
		enterRule(_localctx, 22, Java8Parser.RULE_interfaceType);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(565);
	...
	public static class InterfaceType_lf_classOrInterfaceTypeContext extends ParserRuleContext {
		...
		public InterfaceType_lf_classOrInterfaceTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInterfaceType_lf_classOrInterfaceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final InterfaceType_lf_classOrInterfaceTypeContext interfaceType_lf_classOrInterfaceType()
			throws RecognitionException {
		final InterfaceType_lf_classOrInterfaceTypeContext _localctx = new InterfaceType_lf_classOrInterfaceTypeContext(
				_ctx, getState());
		enterRule(_localctx, 24, Java8Parser.RULE_interfaceType_lf_classOrInterfaceType);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(567);
	...
	public static class InterfaceType_lfno_classOrInterfaceTypeContext extends ParserRuleContext {
		...
		public InterfaceType_lfno_classOrInterfaceTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInterfaceType_lfno_classOrInterfaceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final InterfaceType_lfno_classOrInterfaceTypeContext interfaceType_lfno_classOrInterfaceType()
			throws RecognitionException {
		final InterfaceType_lfno_classOrInterfaceTypeContext _localctx = new InterfaceType_lfno_classOrInterfaceTypeContext(
				_ctx, getState());
		enterRule(_localctx, 26, Java8Parser.RULE_interfaceType_lfno_classOrInterfaceType);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(569);
	...
	public static class TypeVariableContext extends ParserRuleContext {
		...
		public TypeVariableContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeVariable(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeVariableContext typeVariable() throws RecognitionException {
		final TypeVariableContext _localctx = new TypeVariableContext(_ctx, getState());
		enterRule(_localctx, 28, Java8Parser.RULE_typeVariable);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ArrayTypeContext extends ParserRuleContext {
		...
		public ArrayTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitArrayType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ArrayTypeContext arrayType() throws RecognitionException {
		final ArrayTypeContext _localctx = new ArrayTypeContext(_ctx, getState());
		enterRule(_localctx, 30, Java8Parser.RULE_arrayType);
		try {
			setState(588);
	...
	public static class DimsContext extends ParserRuleContext {
		...
		public DimsContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
	...
	public final DimsContext dims() throws RecognitionException {
		final DimsContext _localctx = new DimsContext(_ctx, getState());
		enterRule(_localctx, 32, Java8Parser.RULE_dims);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public static class TypeParameterContext extends ParserRuleContext {
		...
		public TypeParameterModifierContext typeParameterModifier(final int i) {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeParameter(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeParameterContext typeParameter() throws RecognitionException {
		...
		enterRule(_localctx, 34, Java8Parser.RULE_typeParameter);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class TypeParameterModifierContext extends ParserRuleContext {
		...
		public TypeParameterModifierContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeParameterModifier(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeParameterModifierContext typeParameterModifier() throws RecognitionException {
		final TypeParameterModifierContext _localctx = new TypeParameterModifierContext(_ctx, getState());
		enterRule(_localctx, 36, Java8Parser.RULE_typeParameterModifier);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(621);
	...
	public static class TypeBoundContext extends ParserRuleContext {
		...
		public AdditionalBoundContext additionalBound(final int i) {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeBound(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeBoundContext typeBound() throws RecognitionException {
		...
		enterRule(_localctx, 38, Java8Parser.RULE_typeBound);
		int _la;
		try {
			setState(633);
	...
	public static class AdditionalBoundContext extends ParserRuleContext {
		...
		public AdditionalBoundContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAdditionalBound(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final AdditionalBoundContext additionalBound() throws RecognitionException {
		final AdditionalBoundContext _localctx = new AdditionalBoundContext(_ctx, getState());
		enterRule(_localctx, 40, Java8Parser.RULE_additionalBound);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(635);
	...
	public static class TypeArgumentsContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeArguments(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeArgumentsContext typeArguments() throws RecognitionException {
		...
		enterRule(_localctx, 42, Java8Parser.RULE_typeArguments);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(638);
	...
	public static class TypeArgumentListContext extends ParserRuleContext {
		...
		public TypeArgumentListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeArgumentList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeArgumentListContext typeArgumentList() throws RecognitionException {
		final TypeArgumentListContext _localctx = new TypeArgumentListContext(_ctx, getState());
		enterRule(_localctx, 44, Java8Parser.RULE_typeArgumentList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class TypeArgumentContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeArgument(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeArgumentContext typeArgument() throws RecognitionException {
		...
		enterRule(_localctx, 46, Java8Parser.RULE_typeArgument);
		try {
			setState(652);
	...
	public static class WildcardContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitWildcard(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final WildcardContext wildcard() throws RecognitionException {
		...
		enterRule(_localctx, 48, Java8Parser.RULE_wildcard);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class WildcardBoundsContext extends ParserRuleContext {
		...
		public WildcardBoundsContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitWildcardBounds(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final WildcardBoundsContext wildcardBounds() throws RecognitionException {
		final WildcardBoundsContext _localctx = new WildcardBoundsContext(_ctx, getState());
		enterRule(_localctx, 50, Java8Parser.RULE_wildcardBounds);
		try {
			setState(668);
			switch (_input.LA(1)) {
			case EXTENDS:
	...
	public static class PackageNameContext extends ParserRuleContext {
		...
		public PackageNameContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPackageName(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private PackageNameContext packageName(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		PackageNameContext _localctx = new PackageNameContext(_ctx, _parentState);
		PackageNameContext _prevctx = _localctx;
		final int _startState = 52;
		enterRecursionRule(_localctx, 52, Java8Parser.RULE_packageName, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
						...
						{
							{
								...
								pushNewRecursionContext(_localctx, _startState, Java8Parser.RULE_packageName);
								setState(673);
								if (!precpred(_ctx, 1)) {
	...
	public static class TypeNameContext extends ParserRuleContext {
		...
		public TypeNameContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeName(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeNameContext typeName() throws RecognitionException {
		final TypeNameContext _localctx = new TypeNameContext(_ctx, getState());
		enterRule(_localctx, 54, Java8Parser.RULE_typeName);
		try {
			setState(686);
	...
	public static class PackageOrTypeNameContext extends ParserRuleContext {
		...
		public PackageOrTypeNameContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPackageOrTypeName(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private PackageOrTypeNameContext packageOrTypeName(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		PackageOrTypeNameContext _localctx = new PackageOrTypeNameContext(_ctx, _parentState);
		PackageOrTypeNameContext _prevctx = _localctx;
		final int _startState = 56;
		enterRecursionRule(_localctx, 56, Java8Parser.RULE_packageOrTypeName, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
						...
						{
							{
								...
								pushNewRecursionContext(_localctx, _startState, Java8Parser.RULE_packageOrTypeName);
								setState(691);
								if (!precpred(_ctx, 1)) {
									throw new FailedPredicateException(this, "precpred(_ctx, 1)");
								}
	...
	public static class ExpressionNameContext extends ParserRuleContext {
		...
		public ExpressionNameContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitExpressionName(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ExpressionNameContext expressionName() throws RecognitionException {
		final ExpressionNameContext _localctx = new ExpressionNameContext(_ctx, getState());
		enterRule(_localctx, 58, Java8Parser.RULE_expressionName);
		try {
			setState(704);
	...
	public static class MethodNameContext extends ParserRuleContext {
		...
		public MethodNameContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMethodName(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MethodNameContext methodName() throws RecognitionException {
		final MethodNameContext _localctx = new MethodNameContext(_ctx, getState());
		enterRule(_localctx, 60, Java8Parser.RULE_methodName);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(706);
	...
	public static class AmbiguousNameContext extends ParserRuleContext {
		...
		public AmbiguousNameContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAmbiguousName(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private AmbiguousNameContext ambiguousName(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		AmbiguousNameContext _localctx = new AmbiguousNameContext(_ctx, _parentState);
		AmbiguousNameContext _prevctx = _localctx;
		final int _startState = 62;
		enterRecursionRule(_localctx, 62, Java8Parser.RULE_ambiguousName, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
						...
						{
							{
								...
								pushNewRecursionContext(_localctx, _startState, Java8Parser.RULE_ambiguousName);
								setState(711);
								if (!precpred(_ctx, 1)) {
									throw new FailedPredicateException(this, "precpred(_ctx, 1)");
								}
	...
	public static class CompilationUnitContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitCompilationUnit(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final CompilationUnitContext compilationUnit() throws RecognitionException {
		...
		enterRule(_localctx, 64, Java8Parser.RULE_compilationUnit);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((_la & ~0x3f) == 0 && (1L << _la & (1L << Java8Parser.ABSTRACT | 1L << Java8Parser.CLASS
						| 1L << Java8Parser.ENUM | 1L << Java8Parser.FINAL | 1L << Java8Parser.INTERFACE
						| 1L << Java8Parser.PRIVATE | 1L << Java8Parser.PROTECTED | 1L << Java8Parser.PUBLIC
						| 1L << Java8Parser.STATIC | 1L << Java8Parser.STRICTFP | 1L << Java8Parser.SEMI)) != 0
						|| _la == Java8Parser.AT) {
					{
						{
							setState(728);
	...
	public static class PackageDeclarationContext extends ParserRuleContext {
		...
		public PackageModifierContext packageModifier(final int i) {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPackageDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PackageDeclarationContext packageDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 66, Java8Parser.RULE_packageDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class PackageModifierContext extends ParserRuleContext {
		...
		public PackageModifierContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPackageModifier(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PackageModifierContext packageModifier() throws RecognitionException {
		final PackageModifierContext _localctx = new PackageModifierContext(_ctx, getState());
		enterRule(_localctx, 68, Java8Parser.RULE_packageModifier);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(753);
	...
	public static class ImportDeclarationContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitImportDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ImportDeclarationContext importDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 70, Java8Parser.RULE_importDeclaration);
		try {
			setState(759);
	...
	public static class SingleTypeImportDeclarationContext extends ParserRuleContext {
		...
		public SingleTypeImportDeclarationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitSingleTypeImportDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final SingleTypeImportDeclarationContext singleTypeImportDeclaration() throws RecognitionException {
		final SingleTypeImportDeclarationContext _localctx = new SingleTypeImportDeclarationContext(_ctx, getState());
		enterRule(_localctx, 72, Java8Parser.RULE_singleTypeImportDeclaration);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(761);
	...
	public static class TypeImportOnDemandDeclarationContext extends ParserRuleContext {
		...
		public TypeImportOnDemandDeclarationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeImportOnDemandDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeImportOnDemandDeclarationContext typeImportOnDemandDeclaration() throws RecognitionException {
		final TypeImportOnDemandDeclarationContext _localctx = new TypeImportOnDemandDeclarationContext(_ctx,
				getState());
		enterRule(_localctx, 74, Java8Parser.RULE_typeImportOnDemandDeclaration);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(765);
	...
	public static class SingleStaticImportDeclarationContext extends ParserRuleContext {
		...
		public SingleStaticImportDeclarationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitSingleStaticImportDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final SingleStaticImportDeclarationContext singleStaticImportDeclaration() throws RecognitionException {
		final SingleStaticImportDeclarationContext _localctx = new SingleStaticImportDeclarationContext(_ctx,
				getState());
		enterRule(_localctx, 76, Java8Parser.RULE_singleStaticImportDeclaration);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(771);
	...
	public static class StaticImportOnDemandDeclarationContext extends ParserRuleContext {
		...
		public StaticImportOnDemandDeclarationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitStaticImportOnDemandDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final StaticImportOnDemandDeclarationContext staticImportOnDemandDeclaration() throws RecognitionException {
		final StaticImportOnDemandDeclarationContext _localctx = new StaticImportOnDemandDeclarationContext(_ctx,
				getState());
		enterRule(_localctx, 78, Java8Parser.RULE_staticImportOnDemandDeclaration);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(778);
	...
	public static class TypeDeclarationContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeDeclarationContext typeDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 80, Java8Parser.RULE_typeDeclaration);
		try {
			setState(788);
	...
	public static class ClassDeclarationContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitClassDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ClassDeclarationContext classDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 82, Java8Parser.RULE_classDeclaration);
		try {
			setState(792);
	...
	public static class NormalClassDeclarationContext extends ParserRuleContext {
		...
		public ClassModifierContext classModifier(final int i) {
		...
		public NormalClassDeclarationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitNormalClassDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final NormalClassDeclarationContext normalClassDeclaration() throws RecognitionException {
		final NormalClassDeclarationContext _localctx = new NormalClassDeclarationContext(_ctx, getState());
		enterRule(_localctx, 84, Java8Parser.RULE_normalClassDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				while ((_la & ~0x3f) == 0
						&& (1L << _la & (1L << Java8Parser.ABSTRACT | 1L << Java8Parser.FINAL
								| 1L << Java8Parser.PRIVATE | 1L << Java8Parser.PROTECTED | 1L << Java8Parser.PUBLIC
								| 1L << Java8Parser.STATIC | 1L << Java8Parser.STRICTFP)) != 0
						|| _la == Java8Parser.AT) {
					{
						{
							setState(794);
	...
	public static class ClassModifierContext extends ParserRuleContext {
		...
		public ClassModifierContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitClassModifier(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ClassModifierContext classModifier() throws RecognitionException {
		...
		enterRule(_localctx, 86, Java8Parser.RULE_classModifier);
		try {
			setState(821);
			switch (_input.LA(1)) {
			case AT:
	...
	public static class TypeParametersContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeParameters(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeParametersContext typeParameters() throws RecognitionException {
		...
		enterRule(_localctx, 88, Java8Parser.RULE_typeParameters);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(823);
	...
	public static class TypeParameterListContext extends ParserRuleContext {
		...
		public TypeParameterListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeParameterList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeParameterListContext typeParameterList() throws RecognitionException {
		final TypeParameterListContext _localctx = new TypeParameterListContext(_ctx, getState());
		enterRule(_localctx, 90, Java8Parser.RULE_typeParameterList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class SuperclassContext extends ParserRuleContext {
		...
		public SuperclassContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitSuperclass(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final SuperclassContext superclass() throws RecognitionException {
		final SuperclassContext _localctx = new SuperclassContext(_ctx, getState());
		enterRule(_localctx, 92, Java8Parser.RULE_superclass);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(835);
	...
	public static class SuperinterfacesContext extends ParserRuleContext {
		...
		public SuperinterfacesContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitSuperinterfaces(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final SuperinterfacesContext superinterfaces() throws RecognitionException {
		final SuperinterfacesContext _localctx = new SuperinterfacesContext(_ctx, getState());
		enterRule(_localctx, 94, Java8Parser.RULE_superinterfaces);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(838);
	...
	public static class InterfaceTypeListContext extends ParserRuleContext {
		...
		public InterfaceTypeContext interfaceType(final int i) {
			return getRuleContext(InterfaceTypeContext.class, i);
		}

		public InterfaceTypeListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInterfaceTypeList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final InterfaceTypeListContext interfaceTypeList() throws RecognitionException {
		final InterfaceTypeListContext _localctx = new InterfaceTypeListContext(_ctx, getState());
		enterRule(_localctx, 96, Java8Parser.RULE_interfaceTypeList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ClassBodyContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitClassBody(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ClassBodyContext classBody() throws RecognitionException {
		...
		enterRule(_localctx, 98, Java8Parser.RULE_classBody);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				while ((_la & ~0x3f) == 0
						&& (1L << _la & (1L << Java8Parser.ABSTRACT | 1L << Java8Parser.BOOLEAN | 1L << Java8Parser.BYTE
								| 1L << Java8Parser.CHAR | 1L << Java8Parser.CLASS | 1L << Java8Parser.DOUBLE
								| 1L << Java8Parser.ENUM | 1L << Java8Parser.FINAL | 1L << Java8Parser.FLOAT
								| 1L << Java8Parser.INT | 1L << Java8Parser.INTERFACE | 1L << Java8Parser.LONG
								| 1L << Java8Parser.NATIVE | 1L << Java8Parser.PRIVATE | 1L << Java8Parser.PROTECTED
								| 1L << Java8Parser.PUBLIC | 1L << Java8Parser.SHORT | 1L << Java8Parser.STATIC
								| 1L << Java8Parser.STRICTFP | 1L << Java8Parser.SYNCHRONIZED
								| 1L << Java8Parser.TRANSIENT | 1L << Java8Parser.VOID | 1L << Java8Parser.VOLATILE
								| 1L << Java8Parser.LBRACE | 1L << Java8Parser.SEMI)) != 0
						|| (_la - 68 & ~0x3f) == 0 && (1L << _la - 68 & (1L << Java8Parser.LT - 68
								| 1L << Java8Parser.Identifier - 68 | 1L << Java8Parser.AT - 68)) != 0) {
					{
						{
							setState(850);
	...
	public static class ClassBodyDeclarationContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitClassBodyDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ClassBodyDeclarationContext classBodyDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 100, Java8Parser.RULE_classBodyDeclaration);
		try {
			setState(862);
	...
	public static class ClassMemberDeclarationContext extends ParserRuleContext {
		...
		public ClassMemberDeclarationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitClassMemberDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ClassMemberDeclarationContext classMemberDeclaration() throws RecognitionException {
		final ClassMemberDeclarationContext _localctx = new ClassMemberDeclarationContext(_ctx, getState());
		enterRule(_localctx, 102, Java8Parser.RULE_classMemberDeclaration);
		try {
			setState(869);
	...
	public static class FieldDeclarationContext extends ParserRuleContext {
		...
		public FieldModifierContext fieldModifier(final int i) {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitFieldDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final FieldDeclarationContext fieldDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 104, Java8Parser.RULE_fieldDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				while ((_la & ~0x3f) == 0
						&& (1L << _la & (1L << Java8Parser.FINAL | 1L << Java8Parser.PRIVATE
								| 1L << Java8Parser.PROTECTED | 1L << Java8Parser.PUBLIC | 1L << Java8Parser.STATIC
								| 1L << Java8Parser.TRANSIENT | 1L << Java8Parser.VOLATILE)) != 0
						|| _la == Java8Parser.AT) {
					{
						{
							setState(871);
	...
	public static class FieldModifierContext extends ParserRuleContext {
		...
		public FieldModifierContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitFieldModifier(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final FieldModifierContext fieldModifier() throws RecognitionException {
		...
		enterRule(_localctx, 106, Java8Parser.RULE_fieldModifier);
		try {
			setState(889);
			switch (_input.LA(1)) {
			case AT:
	...
	public static class VariableDeclaratorListContext extends ParserRuleContext {
		...
		public VariableDeclaratorListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitVariableDeclaratorList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final VariableDeclaratorListContext variableDeclaratorList() throws RecognitionException {
		final VariableDeclaratorListContext _localctx = new VariableDeclaratorListContext(_ctx, getState());
		enterRule(_localctx, 108, Java8Parser.RULE_variableDeclaratorList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class VariableDeclaratorContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitVariableDeclarator(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final VariableDeclaratorContext variableDeclarator() throws RecognitionException {
		...
		enterRule(_localctx, 110, Java8Parser.RULE_variableDeclarator);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class VariableDeclaratorIdContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitVariableDeclaratorId(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final VariableDeclaratorIdContext variableDeclaratorId() throws RecognitionException {
		...
		enterRule(_localctx, 112, Java8Parser.RULE_variableDeclaratorId);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class VariableInitializerContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitVariableInitializer(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final VariableInitializerContext variableInitializer() throws RecognitionException {
		...
		enterRule(_localctx, 114, Java8Parser.RULE_variableInitializer);
		try {
			setState(910);
			switch (_input.LA(1)) {
			case BOOLEAN:
	...
	public static class UnannTypeContext extends ParserRuleContext {
		...
		public UnannTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnannType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnannTypeContext unannType() throws RecognitionException {
		final UnannTypeContext _localctx = new UnannTypeContext(_ctx, getState());
		enterRule(_localctx, 116, Java8Parser.RULE_unannType);
		try {
			setState(914);
	...
	public static class UnannPrimitiveTypeContext extends ParserRuleContext {
		...
		public UnannPrimitiveTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnannPrimitiveType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnannPrimitiveTypeContext unannPrimitiveType() throws RecognitionException {
		final UnannPrimitiveTypeContext _localctx = new UnannPrimitiveTypeContext(_ctx, getState());
		enterRule(_localctx, 118, Java8Parser.RULE_unannPrimitiveType);
		try {
			setState(918);
			switch (_input.LA(1)) {
			case BYTE:
	...
	public static class UnannReferenceTypeContext extends ParserRuleContext {
		...
		public UnannReferenceTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnannReferenceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnannReferenceTypeContext unannReferenceType() throws RecognitionException {
		final UnannReferenceTypeContext _localctx = new UnannReferenceTypeContext(_ctx, getState());
		enterRule(_localctx, 120, Java8Parser.RULE_unannReferenceType);
		try {
			setState(923);
	...
	public static class UnannClassOrInterfaceTypeContext extends ParserRuleContext {
		...
		public UnannClassOrInterfaceTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnannClassOrInterfaceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnannClassOrInterfaceTypeContext unannClassOrInterfaceType() throws RecognitionException {
		final UnannClassOrInterfaceTypeContext _localctx = new UnannClassOrInterfaceTypeContext(_ctx, getState());
		enterRule(_localctx, 122, Java8Parser.RULE_unannClassOrInterfaceType);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class UnannClassTypeContext extends ParserRuleContext {
		...
		public UnannClassTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnannClassType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnannClassTypeContext unannClassType() throws RecognitionException {
		final UnannClassTypeContext _localctx = new UnannClassTypeContext(_ctx, getState());
		enterRule(_localctx, 124, Java8Parser.RULE_unannClassType);
		int _la;
		try {
			setState(952);
	...
	public static class UnannClassType_lf_unannClassOrInterfaceTypeContext extends ParserRuleContext {
		...
		public UnannClassType_lf_unannClassOrInterfaceTypeContext(final ParserRuleContext parent,
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnannClassType_lf_unannClassOrInterfaceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnannClassType_lf_unannClassOrInterfaceTypeContext unannClassType_lf_unannClassOrInterfaceType()
			throws RecognitionException {
		final UnannClassType_lf_unannClassOrInterfaceTypeContext _localctx = new UnannClassType_lf_unannClassOrInterfaceTypeContext(
				_ctx, getState());
		enterRule(_localctx, 126, Java8Parser.RULE_unannClassType_lf_unannClassOrInterfaceType);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class UnannClassType_lfno_unannClassOrInterfaceTypeContext extends ParserRuleContext {
		...
		public UnannClassType_lfno_unannClassOrInterfaceTypeContext(final ParserRuleContext parent,
				final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnannClassType_lfno_unannClassOrInterfaceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnannClassType_lfno_unannClassOrInterfaceTypeContext unannClassType_lfno_unannClassOrInterfaceType()
			throws RecognitionException {
		final UnannClassType_lfno_unannClassOrInterfaceTypeContext _localctx = new UnannClassType_lfno_unannClassOrInterfaceTypeContext(
				_ctx, getState());
		enterRule(_localctx, 128, Java8Parser.RULE_unannClassType_lfno_unannClassOrInterfaceType);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class UnannInterfaceTypeContext extends ParserRuleContext {
		...
		public UnannInterfaceTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnannInterfaceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnannInterfaceTypeContext unannInterfaceType() throws RecognitionException {
		final UnannInterfaceTypeContext _localctx = new UnannInterfaceTypeContext(_ctx, getState());
		enterRule(_localctx, 130, Java8Parser.RULE_unannInterfaceType);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(969);
	...
	public static class UnannInterfaceType_lf_unannClassOrInterfaceTypeContext extends ParserRuleContext {
		...
		public UnannInterfaceType_lf_unannClassOrInterfaceTypeContext(final ParserRuleContext parent,
				final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnannInterfaceType_lf_unannClassOrInterfaceType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnannInterfaceType_lf_unannClassOrInterfaceTypeContext unannInterfaceType_lf_unannClassOrInterfaceType()
			throws RecognitionException {
		final UnannInterfaceType_lf_unannClassOrInterfaceTypeContext _localctx = new UnannInterfaceType_lf_unannClassOrInterfaceTypeContext(
				_ctx, getState());
		enterRule(_localctx, 132, Java8Parser.RULE_unannInterfaceType_lf_unannClassOrInterfaceType);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(971);
	...
	public static class UnannInterfaceType_lfno_unannClassOrInterfaceTypeContext extends ParserRuleContext {
		...
		public UnannInterfaceType_lfno_unannClassOrInterfaceTypeContext(final ParserRuleContext parent,
				final int invokingState) {
			super(parent, invokingState);
		}
	...
	public final UnannInterfaceType_lfno_unannClassOrInterfaceTypeContext unannInterfaceType_lfno_unannClassOrInterfaceType()
			throws RecognitionException {
		final UnannInterfaceType_lfno_unannClassOrInterfaceTypeContext _localctx = new UnannInterfaceType_lfno_unannClassOrInterfaceTypeContext(
				_ctx, getState());
		enterRule(_localctx, 134, Java8Parser.RULE_unannInterfaceType_lfno_unannClassOrInterfaceType);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(973);
	...
	public static class UnannTypeVariableContext extends ParserRuleContext {
		...
		public UnannTypeVariableContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnannTypeVariable(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnannTypeVariableContext unannTypeVariable() throws RecognitionException {
		final UnannTypeVariableContext _localctx = new UnannTypeVariableContext(_ctx, getState());
		enterRule(_localctx, 136, Java8Parser.RULE_unannTypeVariable);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(975);
	...
	public static class UnannArrayTypeContext extends ParserRuleContext {
		...
		public UnannArrayTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnannArrayType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnannArrayTypeContext unannArrayType() throws RecognitionException {
		final UnannArrayTypeContext _localctx = new UnannArrayTypeContext(_ctx, getState());
		enterRule(_localctx, 138, Java8Parser.RULE_unannArrayType);
		try {
			setState(986);
	...
	public static class MethodDeclarationContext extends ParserRuleContext {
		...
		public MethodModifierContext methodModifier(final int i) {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMethodDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MethodDeclarationContext methodDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 140, Java8Parser.RULE_methodDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((_la & ~0x3f) == 0 && (1L << _la & (1L << Java8Parser.ABSTRACT | 1L << Java8Parser.FINAL
						| 1L << Java8Parser.NATIVE | 1L << Java8Parser.PRIVATE | 1L << Java8Parser.PROTECTED
						| 1L << Java8Parser.PUBLIC | 1L << Java8Parser.STATIC | 1L << Java8Parser.STRICTFP
						| 1L << Java8Parser.SYNCHRONIZED)) != 0 || _la == Java8Parser.AT) {
					{
						{
							setState(988);
							methodModifier();
	...
	public static class MethodModifierContext extends ParserRuleContext {
		...
		public MethodModifierContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMethodModifier(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MethodModifierContext methodModifier() throws RecognitionException {
		final MethodModifierContext _localctx = new MethodModifierContext(_ctx, getState());
		enterRule(_localctx, 142, Java8Parser.RULE_methodModifier);
		try {
			setState(1007);
			switch (_input.LA(1)) {
			case AT:
	...
	public static class MethodHeaderContext extends ParserRuleContext {
		...
		public MethodHeaderContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMethodHeader(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MethodHeaderContext methodHeader() throws RecognitionException {
		final MethodHeaderContext _localctx = new MethodHeaderContext(_ctx, getState());
		enterRule(_localctx, 144, Java8Parser.RULE_methodHeader);
		int _la;
		try {
			setState(1026);
			switch (_input.LA(1)) {
	...
	public static class ResultContext extends ParserRuleContext {
		...
		public ResultContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
	...
	public final ResultContext result() throws RecognitionException {
		final ResultContext _localctx = new ResultContext(_ctx, getState());
		enterRule(_localctx, 146, Java8Parser.RULE_result);
		try {
			setState(1030);
			switch (_input.LA(1)) {
			case BOOLEAN:
	...
	public static class MethodDeclaratorContext extends ParserRuleContext {
		...
		public MethodDeclaratorContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMethodDeclarator(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MethodDeclaratorContext methodDeclarator() throws RecognitionException {
		final MethodDeclaratorContext _localctx = new MethodDeclaratorContext(_ctx, getState());
		enterRule(_localctx, 148, Java8Parser.RULE_methodDeclarator);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				if ((_la & ~0x3f) == 0
						&& (1L << _la & (1L << Java8Parser.BOOLEAN | 1L << Java8Parser.BYTE | 1L << Java8Parser.CHAR
								| 1L << Java8Parser.DOUBLE | 1L << Java8Parser.FINAL | 1L << Java8Parser.FLOAT
								| 1L << Java8Parser.INT | 1L << Java8Parser.LONG | 1L << Java8Parser.SHORT)) != 0
						|| _la == Java8Parser.Identifier || _la == Java8Parser.AT) {
					{
						setState(1034);
						formalParameterList();
					}
	...
	public static class FormalParameterListContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitFormalParameterList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final FormalParameterListContext formalParameterList() throws RecognitionException {
		...
		enterRule(_localctx, 150, Java8Parser.RULE_formalParameterList);
		try {
			setState(1046);
	...
	public static class FormalParametersContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitFormalParameters(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final FormalParametersContext formalParameters() throws RecognitionException {
		...
		enterRule(_localctx, 152, Java8Parser.RULE_formalParameters);
		try {
			int _alt;
			setState(1064);
	...
	public static class FormalParameterContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitFormalParameter(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final FormalParameterContext formalParameter() throws RecognitionException {
		...
		enterRule(_localctx, 154, Java8Parser.RULE_formalParameter);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class VariableModifierContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitVariableModifier(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final VariableModifierContext variableModifier() throws RecognitionException {
		...
		enterRule(_localctx, 156, Java8Parser.RULE_variableModifier);
		try {
			setState(1077);
			switch (_input.LA(1)) {
			case AT:
	...
	public static class LastFormalParameterContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitLastFormalParameter(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final LastFormalParameterContext lastFormalParameter() throws RecognitionException {
		...
		enterRule(_localctx, 158, Java8Parser.RULE_lastFormalParameter);
		int _la;
		try {
			setState(1096);
	...
	public static class ReceiverParameterContext extends ParserRuleContext {
		...
		public ReceiverParameterContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitReceiverParameter(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ReceiverParameterContext receiverParameter() throws RecognitionException {
		final ReceiverParameterContext _localctx = new ReceiverParameterContext(_ctx, getState());
		enterRule(_localctx, 160, Java8Parser.RULE_receiverParameter);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class Throws_Context extends ParserRuleContext {
		...
		public Throws_Context(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
	...
	public final Throws_Context throws_() throws RecognitionException {
		final Throws_Context _localctx = new Throws_Context(_ctx, getState());
		enterRule(_localctx, 162, Java8Parser.RULE_throws_);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1111);
	...
	public static class ExceptionTypeListContext extends ParserRuleContext {
		...
		public ExceptionTypeContext exceptionType(final int i) {
			return getRuleContext(ExceptionTypeContext.class, i);
		}

		public ExceptionTypeListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitExceptionTypeList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ExceptionTypeListContext exceptionTypeList() throws RecognitionException {
		final ExceptionTypeListContext _localctx = new ExceptionTypeListContext(_ctx, getState());
		enterRule(_localctx, 164, Java8Parser.RULE_exceptionTypeList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ExceptionTypeContext extends ParserRuleContext {
		...
		public ExceptionTypeContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitExceptionType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ExceptionTypeContext exceptionType() throws RecognitionException {
		final ExceptionTypeContext _localctx = new ExceptionTypeContext(_ctx, getState());
		enterRule(_localctx, 166, Java8Parser.RULE_exceptionType);
		try {
			setState(1124);
	...
	public static class MethodBodyContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMethodBody(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MethodBodyContext methodBody() throws RecognitionException {
		...
		enterRule(_localctx, 168, Java8Parser.RULE_methodBody);
		try {
			setState(1128);
			switch (_input.LA(1)) {
			case LBRACE:
	...
	public static class InstanceInitializerContext extends ParserRuleContext {
		...
		public InstanceInitializerContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInstanceInitializer(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final InstanceInitializerContext instanceInitializer() throws RecognitionException {
		final InstanceInitializerContext _localctx = new InstanceInitializerContext(_ctx, getState());
		enterRule(_localctx, 170, Java8Parser.RULE_instanceInitializer);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1130);
	...
	public static class StaticInitializerContext extends ParserRuleContext {
		...
		public StaticInitializerContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitStaticInitializer(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final StaticInitializerContext staticInitializer() throws RecognitionException {
		final StaticInitializerContext _localctx = new StaticInitializerContext(_ctx, getState());
		enterRule(_localctx, 172, Java8Parser.RULE_staticInitializer);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1132);
	...
	public static class ConstructorDeclarationContext extends ParserRuleContext {
		...
		public ConstructorModifierContext constructorModifier(final int i) {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitConstructorDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ConstructorDeclarationContext constructorDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 174, Java8Parser.RULE_constructorDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				while ((_la & ~0x3f) == 0 && (1L << _la
						& (1L << Java8Parser.PRIVATE | 1L << Java8Parser.PROTECTED | 1L << Java8Parser.PUBLIC)) != 0
						|| _la == Java8Parser.AT) {
					{
						{
							setState(1135);
	...
	public static class ConstructorModifierContext extends ParserRuleContext {
		...
		public ConstructorModifierContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitConstructorModifier(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ConstructorModifierContext constructorModifier() throws RecognitionException {
		final ConstructorModifierContext _localctx = new ConstructorModifierContext(_ctx, getState());
		enterRule(_localctx, 176, Java8Parser.RULE_constructorModifier);
		try {
			setState(1151);
			switch (_input.LA(1)) {
			case AT:
	...
	public static class ConstructorDeclaratorContext extends ParserRuleContext {
		...
		public ConstructorDeclaratorContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitConstructorDeclarator(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ConstructorDeclaratorContext constructorDeclarator() throws RecognitionException {
		final ConstructorDeclaratorContext _localctx = new ConstructorDeclaratorContext(_ctx, getState());
		enterRule(_localctx, 178, Java8Parser.RULE_constructorDeclarator);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class SimpleTypeNameContext extends ParserRuleContext {
		...
		public SimpleTypeNameContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitSimpleTypeName(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final SimpleTypeNameContext simpleTypeName() throws RecognitionException {
		final SimpleTypeNameContext _localctx = new SimpleTypeNameContext(_ctx, getState());
		enterRule(_localctx, 180, Java8Parser.RULE_simpleTypeName);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1163);
	...
	public static class ConstructorBodyContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitConstructorBody(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ConstructorBodyContext constructorBody() throws RecognitionException {
		...
		enterRule(_localctx, 182, Java8Parser.RULE_constructorBody);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				if ((_la & ~0x3f) == 0
						&& (1L << _la & (1L << Java8Parser.ABSTRACT | 1L << Java8Parser.ASSERT
								| 1L << Java8Parser.BOOLEAN | 1L << Java8Parser.BREAK | 1L << Java8Parser.BYTE
								| 1L << Java8Parser.CHAR | 1L << Java8Parser.CLASS | 1L << Java8Parser.CONTINUE
								| 1L << Java8Parser.DO | 1L << Java8Parser.DOUBLE | 1L << Java8Parser.ENUM
								| 1L << Java8Parser.FINAL | 1L << Java8Parser.FLOAT | 1L << Java8Parser.FOR
								| 1L << Java8Parser.IF | 1L << Java8Parser.INT | 1L << Java8Parser.LONG
								| 1L << Java8Parser.NEW | 1L << Java8Parser.PRIVATE | 1L << Java8Parser.PROTECTED
								| 1L << Java8Parser.PUBLIC | 1L << Java8Parser.RETURN | 1L << Java8Parser.SHORT
								| 1L << Java8Parser.STATIC | 1L << Java8Parser.STRICTFP | 1L << Java8Parser.SUPER
								| 1L << Java8Parser.SWITCH | 1L << Java8Parser.SYNCHRONIZED | 1L << Java8Parser.THIS
								| 1L << Java8Parser.THROW | 1L << Java8Parser.TRY | 1L << Java8Parser.VOID
								| 1L << Java8Parser.WHILE | 1L << Java8Parser.IntegerLiteral
								| 1L << Java8Parser.FloatingPointLiteral | 1L << Java8Parser.BooleanLiteral
								| 1L << Java8Parser.CharacterLiteral | 1L << Java8Parser.StringLiteral
								| 1L << Java8Parser.NullLiteral | 1L << Java8Parser.LPAREN | 1L << Java8Parser.LBRACE
								| 1L << Java8Parser.SEMI)) != 0
						|| (_la - 79 & ~0x3f) == 0
								&& (1L << _la - 79 & (1L << Java8Parser.INC - 79 | 1L << Java8Parser.DEC - 79
										| 1L << Java8Parser.Identifier - 79 | 1L << Java8Parser.AT - 79)) != 0) {
					{
						setState(1169);
						blockStatements();
					}
	...
	public static class ExplicitConstructorInvocationContext extends ParserRuleContext {
		...
		public ExplicitConstructorInvocationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitExplicitConstructorInvocation(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ExplicitConstructorInvocationContext explicitConstructorInvocation() throws RecognitionException {
		final ExplicitConstructorInvocationContext _localctx = new ExplicitConstructorInvocationContext(_ctx,
				getState());
		enterRule(_localctx, 184, Java8Parser.RULE_explicitConstructorInvocation);
		int _la;
		try {
			setState(1220);
			...
			case 1:
				...
				if ((_la & ~0x3f) == 0
						&& (1L << _la & (1L << Java8Parser.BOOLEAN | 1L << Java8Parser.BYTE | 1L << Java8Parser.CHAR
								| 1L << Java8Parser.DOUBLE | 1L << Java8Parser.FLOAT | 1L << Java8Parser.INT
								| 1L << Java8Parser.LONG | 1L << Java8Parser.NEW | 1L << Java8Parser.SHORT
								| 1L << Java8Parser.SUPER | 1L << Java8Parser.THIS | 1L << Java8Parser.VOID
								| 1L << Java8Parser.IntegerLiteral | 1L << Java8Parser.FloatingPointLiteral
								| 1L << Java8Parser.BooleanLiteral | 1L << Java8Parser.CharacterLiteral
								| 1L << Java8Parser.StringLiteral | 1L << Java8Parser.NullLiteral
								| 1L << Java8Parser.LPAREN)) != 0
						|| (_la - 69 & ~0x3f) == 0 && (1L << _la - 69 & (1L << Java8Parser.BANG - 69
								| 1L << Java8Parser.TILDE - 69 | 1L << Java8Parser.INC - 69 | 1L << Java8Parser.DEC - 69
								| 1L << Java8Parser.ADD - 69 | 1L << Java8Parser.SUB - 69
								| 1L << Java8Parser.Identifier - 69 | 1L << Java8Parser.AT - 69)) != 0) {
					{
						setState(1179);
						argumentList();
					}
	...
	public static class EnumDeclarationContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitEnumDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final EnumDeclarationContext enumDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 186, Java8Parser.RULE_enumDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class EnumBodyContext extends ParserRuleContext {
		...
		public EnumBodyContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitEnumBody(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final EnumBodyContext enumBody() throws RecognitionException {
		final EnumBodyContext _localctx = new EnumBodyContext(_ctx, getState());
		enterRule(_localctx, 188, Java8Parser.RULE_enumBody);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class EnumConstantListContext extends ParserRuleContext {
		...
		public EnumConstantListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitEnumConstantList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final EnumConstantListContext enumConstantList() throws RecognitionException {
		final EnumConstantListContext _localctx = new EnumConstantListContext(_ctx, getState());
		enterRule(_localctx, 190, Java8Parser.RULE_enumConstantList);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class EnumConstantContext extends ParserRuleContext {
		...
		public EnumConstantModifierContext enumConstantModifier(final int i) {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitEnumConstant(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final EnumConstantContext enumConstant() throws RecognitionException {
		...
		enterRule(_localctx, 192, Java8Parser.RULE_enumConstant);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				if (_la == Java8Parser.LPAREN) {
					{
						...
						_la = _input.LA(1);
						if ((_la & ~0x3f) == 0
								&& (1L << _la & (1L << Java8Parser.BOOLEAN | 1L << Java8Parser.BYTE
										| 1L << Java8Parser.CHAR | 1L << Java8Parser.DOUBLE | 1L << Java8Parser.FLOAT
										| 1L << Java8Parser.INT | 1L << Java8Parser.LONG | 1L << Java8Parser.NEW
										| 1L << Java8Parser.SHORT | 1L << Java8Parser.SUPER | 1L << Java8Parser.THIS
										| 1L << Java8Parser.VOID | 1L << Java8Parser.IntegerLiteral
										| 1L << Java8Parser.FloatingPointLiteral | 1L << Java8Parser.BooleanLiteral
										| 1L << Java8Parser.CharacterLiteral | 1L << Java8Parser.StringLiteral
										| 1L << Java8Parser.NullLiteral | 1L << Java8Parser.LPAREN)) != 0
								|| (_la - 69 & ~0x3f) == 0 && (1L << _la - 69 & (1L << Java8Parser.BANG - 69
										| 1L << Java8Parser.TILDE - 69 | 1L << Java8Parser.INC - 69
										| 1L << Java8Parser.DEC - 69 | 1L << Java8Parser.ADD - 69
										| 1L << Java8Parser.SUB - 69 | 1L << Java8Parser.Identifier - 69
										| 1L << Java8Parser.AT - 69)) != 0) {
							{
								setState(1263);
								argumentList();
							}
	...
	public static class EnumConstantModifierContext extends ParserRuleContext {
		...
		public EnumConstantModifierContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitEnumConstantModifier(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final EnumConstantModifierContext enumConstantModifier() throws RecognitionException {
		final EnumConstantModifierContext _localctx = new EnumConstantModifierContext(_ctx, getState());
		enterRule(_localctx, 194, Java8Parser.RULE_enumConstantModifier);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1272);
	...
	public static class EnumBodyDeclarationsContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitEnumBodyDeclarations(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final EnumBodyDeclarationsContext enumBodyDeclarations() throws RecognitionException {
		...
		enterRule(_localctx, 196, Java8Parser.RULE_enumBodyDeclarations);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class InterfaceDeclarationContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInterfaceDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final InterfaceDeclarationContext interfaceDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 198, Java8Parser.RULE_interfaceDeclaration);
		try {
			setState(1283);
	...
	public static class NormalInterfaceDeclarationContext extends ParserRuleContext {
		...
		public InterfaceModifierContext interfaceModifier(final int i) {
		...
		public NormalInterfaceDeclarationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitNormalInterfaceDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final NormalInterfaceDeclarationContext normalInterfaceDeclaration() throws RecognitionException {
		final NormalInterfaceDeclarationContext _localctx = new NormalInterfaceDeclarationContext(_ctx, getState());
		enterRule(_localctx, 200, Java8Parser.RULE_normalInterfaceDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((_la & ~0x3f) == 0 && (1L << _la & (1L << Java8Parser.ABSTRACT | 1L << Java8Parser.PRIVATE
						| 1L << Java8Parser.PROTECTED | 1L << Java8Parser.PUBLIC | 1L << Java8Parser.STATIC
						| 1L << Java8Parser.STRICTFP)) != 0 || _la == Java8Parser.AT) {
					{
						{
							setState(1285);
							interfaceModifier();
	...
	public static class InterfaceModifierContext extends ParserRuleContext {
		...
		public InterfaceModifierContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInterfaceModifier(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final InterfaceModifierContext interfaceModifier() throws RecognitionException {
		final InterfaceModifierContext _localctx = new InterfaceModifierContext(_ctx, getState());
		enterRule(_localctx, 202, Java8Parser.RULE_interfaceModifier);
		try {
			setState(1308);
			switch (_input.LA(1)) {
			case AT:
	...
	public static class ExtendsInterfacesContext extends ParserRuleContext {
		...
		public ExtendsInterfacesContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitExtendsInterfaces(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ExtendsInterfacesContext extendsInterfaces() throws RecognitionException {
		final ExtendsInterfacesContext _localctx = new ExtendsInterfacesContext(_ctx, getState());
		enterRule(_localctx, 204, Java8Parser.RULE_extendsInterfaces);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1310);
	...
	public static class InterfaceBodyContext extends ParserRuleContext {
		...
		public InterfaceMemberDeclarationContext interfaceMemberDeclaration(final int i) {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInterfaceBody(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final InterfaceBodyContext interfaceBody() throws RecognitionException {
		...
		enterRule(_localctx, 206, Java8Parser.RULE_interfaceBody);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				while ((_la & ~0x3f) == 0
						&& (1L << _la & (1L << Java8Parser.ABSTRACT | 1L << Java8Parser.BOOLEAN | 1L << Java8Parser.BYTE
								| 1L << Java8Parser.CHAR | 1L << Java8Parser.CLASS | 1L << Java8Parser.DEFAULT
								| 1L << Java8Parser.DOUBLE | 1L << Java8Parser.ENUM | 1L << Java8Parser.FINAL
								| 1L << Java8Parser.FLOAT | 1L << Java8Parser.INT | 1L << Java8Parser.INTERFACE
								| 1L << Java8Parser.LONG | 1L << Java8Parser.PRIVATE | 1L << Java8Parser.PROTECTED
								| 1L << Java8Parser.PUBLIC | 1L << Java8Parser.SHORT | 1L << Java8Parser.STATIC
								| 1L << Java8Parser.STRICTFP | 1L << Java8Parser.VOID | 1L << Java8Parser.SEMI)) != 0
						|| (_la - 68 & ~0x3f) == 0 && (1L << _la - 68 & (1L << Java8Parser.LT - 68
								| 1L << Java8Parser.Identifier - 68 | 1L << Java8Parser.AT - 68)) != 0) {
					{
						{
	...
	public static class InterfaceMemberDeclarationContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInterfaceMemberDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final InterfaceMemberDeclarationContext interfaceMemberDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 208, Java8Parser.RULE_interfaceMemberDeclaration);
		try {
			setState(1327);
	...
	public static class ConstantDeclarationContext extends ParserRuleContext {
		...
		public ConstantModifierContext constantModifier(final int i) {
			return getRuleContext(ConstantModifierContext.class, i);
		}

		public ConstantDeclarationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitConstantDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ConstantDeclarationContext constantDeclaration() throws RecognitionException {
		final ConstantDeclarationContext _localctx = new ConstantDeclarationContext(_ctx, getState());
		enterRule(_localctx, 210, Java8Parser.RULE_constantDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				while ((_la & ~0x3f) == 0
						&& (1L << _la
								& (1L << Java8Parser.FINAL | 1L << Java8Parser.PUBLIC | 1L << Java8Parser.STATIC)) != 0
						|| _la == Java8Parser.AT) {
					{
						{
							setState(1329);
	...
	public static class ConstantModifierContext extends ParserRuleContext {
		...
		public ConstantModifierContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitConstantModifier(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ConstantModifierContext constantModifier() throws RecognitionException {
		final ConstantModifierContext _localctx = new ConstantModifierContext(_ctx, getState());
		enterRule(_localctx, 212, Java8Parser.RULE_constantModifier);
		try {
			setState(1343);
			switch (_input.LA(1)) {
			case AT:
	...
	public static class InterfaceMethodDeclarationContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInterfaceMethodDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final InterfaceMethodDeclarationContext interfaceMethodDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 214, Java8Parser.RULE_interfaceMethodDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				while ((_la & ~0x3f) == 0
						&& (1L << _la
								& (1L << Java8Parser.ABSTRACT | 1L << Java8Parser.DEFAULT | 1L << Java8Parser.PUBLIC
										| 1L << Java8Parser.STATIC | 1L << Java8Parser.STRICTFP)) != 0
						|| _la == Java8Parser.AT) {
					{
						{
	...
	public static class InterfaceMethodModifierContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInterfaceMethodModifier(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final InterfaceMethodModifierContext interfaceMethodModifier() throws RecognitionException {
		...
		enterRule(_localctx, 216, Java8Parser.RULE_interfaceMethodModifier);
		try {
			setState(1360);
			switch (_input.LA(1)) {
			case AT:
	...
	public static class AnnotationTypeDeclarationContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAnnotationTypeDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final AnnotationTypeDeclarationContext annotationTypeDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 218, Java8Parser.RULE_annotationTypeDeclaration);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class AnnotationTypeBodyContext extends ParserRuleContext {
		...
		public AnnotationTypeMemberDeclarationContext annotationTypeMemberDeclaration(final int i) {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAnnotationTypeBody(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final AnnotationTypeBodyContext annotationTypeBody() throws RecognitionException {
		...
		enterRule(_localctx, 220, Java8Parser.RULE_annotationTypeBody);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				while ((_la & ~0x3f) == 0
						&& (1L << _la & (1L << Java8Parser.ABSTRACT | 1L << Java8Parser.BOOLEAN | 1L << Java8Parser.BYTE
								...
								| 1L << Java8Parser.INT | 1L << Java8Parser.INTERFACE | 1L << Java8Parser.LONG
								| 1L << Java8Parser.PRIVATE | 1L << Java8Parser.PROTECTED | 1L << Java8Parser.PUBLIC
								| 1L << Java8Parser.SHORT | 1L << Java8Parser.STATIC | 1L << Java8Parser.STRICTFP
								| 1L << Java8Parser.SEMI)) != 0
						|| _la == Java8Parser.Identifier || _la == Java8Parser.AT) {
					{
						{
	...
	public static class AnnotationTypeMemberDeclarationContext extends ParserRuleContext {
		...
		public AnnotationTypeMemberDeclarationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAnnotationTypeMemberDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final AnnotationTypeMemberDeclarationContext annotationTypeMemberDeclaration() throws RecognitionException {
		final AnnotationTypeMemberDeclarationContext _localctx = new AnnotationTypeMemberDeclarationContext(_ctx,
				getState());
		enterRule(_localctx, 222, Java8Parser.RULE_annotationTypeMemberDeclaration);
		try {
			setState(1387);
	...
	public static class AnnotationTypeElementDeclarationContext extends ParserRuleContext {
		...
		public AnnotationTypeElementModifierContext annotationTypeElementModifier(final int i) {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAnnotationTypeElementDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final AnnotationTypeElementDeclarationContext annotationTypeElementDeclaration()
			throws RecognitionException {
		final AnnotationTypeElementDeclarationContext _localctx = new AnnotationTypeElementDeclarationContext(_ctx,
				getState());
		enterRule(_localctx, 224, Java8Parser.RULE_annotationTypeElementDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class AnnotationTypeElementModifierContext extends ParserRuleContext {
		...
		public AnnotationTypeElementModifierContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAnnotationTypeElementModifier(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final AnnotationTypeElementModifierContext annotationTypeElementModifier() throws RecognitionException {
		final AnnotationTypeElementModifierContext _localctx = new AnnotationTypeElementModifierContext(_ctx,
				getState());
		enterRule(_localctx, 226, Java8Parser.RULE_annotationTypeElementModifier);
		try {
			setState(1410);
			switch (_input.LA(1)) {
			case AT:
	...
	public static class DefaultValueContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitDefaultValue(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final DefaultValueContext defaultValue() throws RecognitionException {
		...
		enterRule(_localctx, 228, Java8Parser.RULE_defaultValue);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1412);
	...
	public static class AnnotationContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAnnotation(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final AnnotationContext annotation() throws RecognitionException {
		...
		enterRule(_localctx, 230, Java8Parser.RULE_annotation);
		try {
			setState(1418);
	...
	public static class NormalAnnotationContext extends ParserRuleContext {
		...
		public NormalAnnotationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitNormalAnnotation(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final NormalAnnotationContext normalAnnotation() throws RecognitionException {
		final NormalAnnotationContext _localctx = new NormalAnnotationContext(_ctx, getState());
		enterRule(_localctx, 232, Java8Parser.RULE_normalAnnotation);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ElementValuePairListContext extends ParserRuleContext {
		...
		public ElementValuePairListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitElementValuePairList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ElementValuePairListContext elementValuePairList() throws RecognitionException {
		final ElementValuePairListContext _localctx = new ElementValuePairListContext(_ctx, getState());
		enterRule(_localctx, 234, Java8Parser.RULE_elementValuePairList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ElementValuePairContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitElementValuePair(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ElementValuePairContext elementValuePair() throws RecognitionException {
		...
		enterRule(_localctx, 236, Java8Parser.RULE_elementValuePair);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1436);
	...
	public static class ElementValueContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitElementValue(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ElementValueContext elementValue() throws RecognitionException {
		...
		enterRule(_localctx, 238, Java8Parser.RULE_elementValue);
		try {
			setState(1443);
	...
	public static class ElementValueArrayInitializerContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitElementValueArrayInitializer(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ElementValueArrayInitializerContext elementValueArrayInitializer() throws RecognitionException {
		...
		enterRule(_localctx, 240, Java8Parser.RULE_elementValueArrayInitializer);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				if ((_la & ~0x3f) == 0
						&& (1L << _la & (1L << Java8Parser.BOOLEAN | 1L << Java8Parser.BYTE | 1L << Java8Parser.CHAR
								...
								| 1L << Java8Parser.BooleanLiteral | 1L << Java8Parser.CharacterLiteral
								| 1L << Java8Parser.StringLiteral | 1L << Java8Parser.NullLiteral
								| 1L << Java8Parser.LPAREN | 1L << Java8Parser.LBRACE)) != 0
						|| (_la - 69 & ~0x3f) == 0 && (1L << _la - 69 & (1L << Java8Parser.BANG - 69
								| 1L << Java8Parser.TILDE - 69 | 1L << Java8Parser.INC - 69 | 1L << Java8Parser.DEC - 69
								| 1L << Java8Parser.ADD - 69 | 1L << Java8Parser.SUB - 69
								| 1L << Java8Parser.Identifier - 69 | 1L << Java8Parser.AT - 69)) != 0) {
	...
	public static class ElementValueListContext extends ParserRuleContext {
		...
		public ElementValueListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitElementValueList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ElementValueListContext elementValueList() throws RecognitionException {
		final ElementValueListContext _localctx = new ElementValueListContext(_ctx, getState());
		enterRule(_localctx, 242, Java8Parser.RULE_elementValueList);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class MarkerAnnotationContext extends ParserRuleContext {
		...
		public MarkerAnnotationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMarkerAnnotation(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MarkerAnnotationContext markerAnnotation() throws RecognitionException {
		final MarkerAnnotationContext _localctx = new MarkerAnnotationContext(_ctx, getState());
		enterRule(_localctx, 244, Java8Parser.RULE_markerAnnotation);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1462);
	...
	public static class SingleElementAnnotationContext extends ParserRuleContext {
		...
		public SingleElementAnnotationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitSingleElementAnnotation(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final SingleElementAnnotationContext singleElementAnnotation() throws RecognitionException {
		final SingleElementAnnotationContext _localctx = new SingleElementAnnotationContext(_ctx, getState());
		enterRule(_localctx, 246, Java8Parser.RULE_singleElementAnnotation);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1465);
	...
	public static class ArrayInitializerContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitArrayInitializer(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		enterRule(_localctx, 248, Java8Parser.RULE_arrayInitializer);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class VariableInitializerListContext extends ParserRuleContext {
		...
		public VariableInitializerListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitVariableInitializerList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final VariableInitializerListContext variableInitializerList() throws RecognitionException {
		final VariableInitializerListContext _localctx = new VariableInitializerListContext(_ctx, getState());
		enterRule(_localctx, 250, Java8Parser.RULE_variableInitializerList);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final BlockContext block() throws RecognitionException {
		...
		enterRule(_localctx, 252, Java8Parser.RULE_block);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class BlockStatementsContext extends ParserRuleContext {
		...
		public BlockStatementsContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitBlockStatements(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final BlockStatementsContext blockStatements() throws RecognitionException {
		final BlockStatementsContext _localctx = new BlockStatementsContext(_ctx, getState());
		enterRule(_localctx, 254, Java8Parser.RULE_blockStatements);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class BlockStatementContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitBlockStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final BlockStatementContext blockStatement() throws RecognitionException {
		...
		enterRule(_localctx, 256, Java8Parser.RULE_blockStatement);
		try {
			setState(1504);
	...
	public static class LocalVariableDeclarationStatementContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitLocalVariableDeclarationStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final LocalVariableDeclarationStatementContext localVariableDeclarationStatement()
			throws RecognitionException {
		final LocalVariableDeclarationStatementContext _localctx = new LocalVariableDeclarationStatementContext(_ctx,
				getState());
		enterRule(_localctx, 258, Java8Parser.RULE_localVariableDeclarationStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1506);
	...
	public static class LocalVariableDeclarationContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitLocalVariableDeclaration(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final LocalVariableDeclarationContext localVariableDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 260, Java8Parser.RULE_localVariableDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final StatementContext statement() throws RecognitionException {
		...
		enterRule(_localctx, 262, Java8Parser.RULE_statement);
		try {
			setState(1524);
	...
	public static class StatementNoShortIfContext extends ParserRuleContext {
		...
		public StatementNoShortIfContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitStatementNoShortIf(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final StatementNoShortIfContext statementNoShortIf() throws RecognitionException {
		final StatementNoShortIfContext _localctx = new StatementNoShortIfContext(_ctx, getState());
		enterRule(_localctx, 264, Java8Parser.RULE_statementNoShortIf);
		try {
			setState(1531);
	...
	public static class StatementWithoutTrailingSubstatementContext extends ParserRuleContext {
		...
		public StatementWithoutTrailingSubstatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitStatementWithoutTrailingSubstatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final StatementWithoutTrailingSubstatementContext statementWithoutTrailingSubstatement()
			throws RecognitionException {
		final StatementWithoutTrailingSubstatementContext _localctx = new StatementWithoutTrailingSubstatementContext(
				_ctx, getState());
		enterRule(_localctx, 266, Java8Parser.RULE_statementWithoutTrailingSubstatement);
		try {
			setState(1545);
			switch (_input.LA(1)) {
			case LBRACE:
	...
	public static class EmptyStatementContext extends ParserRuleContext {
		...
		public EmptyStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitEmptyStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final EmptyStatementContext emptyStatement() throws RecognitionException {
		final EmptyStatementContext _localctx = new EmptyStatementContext(_ctx, getState());
		enterRule(_localctx, 268, Java8Parser.RULE_emptyStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1547);
	...
	public static class LabeledStatementContext extends ParserRuleContext {
		...
		public LabeledStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitLabeledStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final LabeledStatementContext labeledStatement() throws RecognitionException {
		final LabeledStatementContext _localctx = new LabeledStatementContext(_ctx, getState());
		enterRule(_localctx, 270, Java8Parser.RULE_labeledStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1549);
	...
	public static class LabeledStatementNoShortIfContext extends ParserRuleContext {
		...
		public LabeledStatementNoShortIfContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitLabeledStatementNoShortIf(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final LabeledStatementNoShortIfContext labeledStatementNoShortIf() throws RecognitionException {
		final LabeledStatementNoShortIfContext _localctx = new LabeledStatementNoShortIfContext(_ctx, getState());
		enterRule(_localctx, 272, Java8Parser.RULE_labeledStatementNoShortIf);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1553);
	...
	public static class ExpressionStatementContext extends ParserRuleContext {
		...
		public ExpressionStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitExpressionStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ExpressionStatementContext expressionStatement() throws RecognitionException {
		final ExpressionStatementContext _localctx = new ExpressionStatementContext(_ctx, getState());
		enterRule(_localctx, 274, Java8Parser.RULE_expressionStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1557);
	...
	public static class StatementExpressionContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitStatementExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final StatementExpressionContext statementExpression() throws RecognitionException {
		...
		enterRule(_localctx, 276, Java8Parser.RULE_statementExpression);
		try {
			setState(1567);
	...
	public static class IfThenStatementContext extends ParserRuleContext {
		...
		public IfThenStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitIfThenStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final IfThenStatementContext ifThenStatement() throws RecognitionException {
		final IfThenStatementContext _localctx = new IfThenStatementContext(_ctx, getState());
		enterRule(_localctx, 278, Java8Parser.RULE_ifThenStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1569);
	...
	public static class IfThenElseStatementContext extends ParserRuleContext {
		...
		public IfThenElseStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitIfThenElseStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final IfThenElseStatementContext ifThenElseStatement() throws RecognitionException {
		final IfThenElseStatementContext _localctx = new IfThenElseStatementContext(_ctx, getState());
		enterRule(_localctx, 280, Java8Parser.RULE_ifThenElseStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1575);
	...
	public static class IfThenElseStatementNoShortIfContext extends ParserRuleContext {
		...
		public StatementNoShortIfContext statementNoShortIf(final int i) {
			return getRuleContext(StatementNoShortIfContext.class, i);
		}

		public IfThenElseStatementNoShortIfContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitIfThenElseStatementNoShortIf(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final IfThenElseStatementNoShortIfContext ifThenElseStatementNoShortIf() throws RecognitionException {
		final IfThenElseStatementNoShortIfContext _localctx = new IfThenElseStatementNoShortIfContext(_ctx, getState());
		enterRule(_localctx, 282, Java8Parser.RULE_ifThenElseStatementNoShortIf);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1583);
	...
	public static class AssertStatementContext extends ParserRuleContext {
		...
		public AssertStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAssertStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final AssertStatementContext assertStatement() throws RecognitionException {
		final AssertStatementContext _localctx = new AssertStatementContext(_ctx, getState());
		enterRule(_localctx, 284, Java8Parser.RULE_assertStatement);
		try {
			setState(1601);
	...
	public static class SwitchStatementContext extends ParserRuleContext {
		...
		public SwitchStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitSwitchStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final SwitchStatementContext switchStatement() throws RecognitionException {
		...
		enterRule(_localctx, 286, Java8Parser.RULE_switchStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1603);
	...
	public static class SwitchBlockContext extends ParserRuleContext {
		...
		public SwitchBlockContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitSwitchBlock(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final SwitchBlockContext switchBlock() throws RecognitionException {
		final SwitchBlockContext _localctx = new SwitchBlockContext(_ctx, getState());
		enterRule(_localctx, 288, Java8Parser.RULE_switchBlock);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public static class SwitchBlockStatementGroupContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitSwitchBlockStatementGroup(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final SwitchBlockStatementGroupContext switchBlockStatementGroup() throws RecognitionException {
		...
		enterRule(_localctx, 290, Java8Parser.RULE_switchBlockStatementGroup);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1624);
	...
	public static class SwitchLabelsContext extends ParserRuleContext {
		...
		public SwitchLabelsContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitSwitchLabels(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final SwitchLabelsContext switchLabels() throws RecognitionException {
		final SwitchLabelsContext _localctx = new SwitchLabelsContext(_ctx, getState());
		enterRule(_localctx, 292, Java8Parser.RULE_switchLabels);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class SwitchLabelContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitSwitchLabel(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final SwitchLabelContext switchLabel() throws RecognitionException {
		...
		enterRule(_localctx, 294, Java8Parser.RULE_switchLabel);
		try {
			setState(1644);
	...
	public static class EnumConstantNameContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitEnumConstantName(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final EnumConstantNameContext enumConstantName() throws RecognitionException {
		...
		enterRule(_localctx, 296, Java8Parser.RULE_enumConstantName);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1646);
	...
	public static class WhileStatementContext extends ParserRuleContext {
		...
		public WhileStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitWhileStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final WhileStatementContext whileStatement() throws RecognitionException {
		...
		enterRule(_localctx, 298, Java8Parser.RULE_whileStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1648);
	...
	public static class WhileStatementNoShortIfContext extends ParserRuleContext {
		...
		public WhileStatementNoShortIfContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitWhileStatementNoShortIf(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final WhileStatementNoShortIfContext whileStatementNoShortIf() throws RecognitionException {
		final WhileStatementNoShortIfContext _localctx = new WhileStatementNoShortIfContext(_ctx, getState());
		enterRule(_localctx, 300, Java8Parser.RULE_whileStatementNoShortIf);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1654);
	...
	public static class DoStatementContext extends ParserRuleContext {
		...
		public DoStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitDoStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final DoStatementContext doStatement() throws RecognitionException {
		...
		enterRule(_localctx, 302, Java8Parser.RULE_doStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1660);
	...
	public static class ForStatementContext extends ParserRuleContext {
		...
		public ForStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitForStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		enterRule(_localctx, 304, Java8Parser.RULE_forStatement);
		try {
			setState(1670);
	...
	public static class ForStatementNoShortIfContext extends ParserRuleContext {
		...
		public ForStatementNoShortIfContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitForStatementNoShortIf(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ForStatementNoShortIfContext forStatementNoShortIf() throws RecognitionException {
		final ForStatementNoShortIfContext _localctx = new ForStatementNoShortIfContext(_ctx, getState());
		enterRule(_localctx, 306, Java8Parser.RULE_forStatementNoShortIf);
		try {
			setState(1674);
	...
	public static class BasicForStatementContext extends ParserRuleContext {
		...
		public BasicForStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitBasicForStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final BasicForStatementContext basicForStatement() throws RecognitionException {
		final BasicForStatementContext _localctx = new BasicForStatementContext(_ctx, getState());
		enterRule(_localctx, 308, Java8Parser.RULE_basicForStatement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class BasicForStatementNoShortIfContext extends ParserRuleContext {
		...
		public BasicForStatementNoShortIfContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitBasicForStatementNoShortIf(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final BasicForStatementNoShortIfContext basicForStatementNoShortIf() throws RecognitionException {
		final BasicForStatementNoShortIfContext _localctx = new BasicForStatementNoShortIfContext(_ctx, getState());
		enterRule(_localctx, 310, Java8Parser.RULE_basicForStatementNoShortIf);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ForInitContext forInit() throws RecognitionException {
		...
		enterRule(_localctx, 312, Java8Parser.RULE_forInit);
		try {
			setState(1710);
	...
	public static class ForUpdateContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitForUpdate(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ForUpdateContext forUpdate() throws RecognitionException {
		...
		enterRule(_localctx, 314, Java8Parser.RULE_forUpdate);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1712);
	...
	public static class StatementExpressionListContext extends ParserRuleContext {
		...
		public StatementExpressionContext statementExpression(final int i) {
			return getRuleContext(StatementExpressionContext.class, i);
		}

		public StatementExpressionListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitStatementExpressionList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final StatementExpressionListContext statementExpressionList() throws RecognitionException {
		final StatementExpressionListContext _localctx = new StatementExpressionListContext(_ctx, getState());
		enterRule(_localctx, 316, Java8Parser.RULE_statementExpressionList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class EnhancedForStatementContext extends ParserRuleContext {
		...
		public EnhancedForStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitEnhancedForStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final EnhancedForStatementContext enhancedForStatement() throws RecognitionException {
		final EnhancedForStatementContext _localctx = new EnhancedForStatementContext(_ctx, getState());
		enterRule(_localctx, 318, Java8Parser.RULE_enhancedForStatement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class EnhancedForStatementNoShortIfContext extends ParserRuleContext {
		...
		public EnhancedForStatementNoShortIfContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitEnhancedForStatementNoShortIf(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final EnhancedForStatementNoShortIfContext enhancedForStatementNoShortIf() throws RecognitionException {
		final EnhancedForStatementNoShortIfContext _localctx = new EnhancedForStatementNoShortIfContext(_ctx,
				getState());
		enterRule(_localctx, 320, Java8Parser.RULE_enhancedForStatementNoShortIf);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class BreakStatementContext extends ParserRuleContext {
		...
		public BreakStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitBreakStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final BreakStatementContext breakStatement() throws RecognitionException {
		...
		enterRule(_localctx, 322, Java8Parser.RULE_breakStatement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ContinueStatementContext extends ParserRuleContext {
		...
		public ContinueStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitContinueStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ContinueStatementContext continueStatement() throws RecognitionException {
		...
		enterRule(_localctx, 324, Java8Parser.RULE_continueStatement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ReturnStatementContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitReturnStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ReturnStatementContext returnStatement() throws RecognitionException {
		...
		enterRule(_localctx, 326, Java8Parser.RULE_returnStatement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ThrowStatementContext extends ParserRuleContext {
		...
		public ThrowStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitThrowStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ThrowStatementContext throwStatement() throws RecognitionException {
		final ThrowStatementContext _localctx = new ThrowStatementContext(_ctx, getState());
		enterRule(_localctx, 328, Java8Parser.RULE_throwStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1770);
	...
	public static class SynchronizedStatementContext extends ParserRuleContext {
		...
		public SynchronizedStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitSynchronizedStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final SynchronizedStatementContext synchronizedStatement() throws RecognitionException {
		final SynchronizedStatementContext _localctx = new SynchronizedStatementContext(_ctx, getState());
		enterRule(_localctx, 330, Java8Parser.RULE_synchronizedStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1774);
	...
	public static class TryStatementContext extends ParserRuleContext {
		...
		public TryStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTryStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TryStatementContext tryStatement() throws RecognitionException {
		final TryStatementContext _localctx = new TryStatementContext(_ctx, getState());
		enterRule(_localctx, 332, Java8Parser.RULE_tryStatement);
		int _la;
		try {
			setState(1792);
	...
	public static class CatchesContext extends ParserRuleContext {
		...
		public CatchesContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
	...
	public final CatchesContext catches() throws RecognitionException {
		final CatchesContext _localctx = new CatchesContext(_ctx, getState());
		enterRule(_localctx, 334, Java8Parser.RULE_catches);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class CatchClauseContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitCatchClause(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final CatchClauseContext catchClause() throws RecognitionException {
		...
		enterRule(_localctx, 336, Java8Parser.RULE_catchClause);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1801);
	...
	public static class CatchFormalParameterContext extends ParserRuleContext {
		...
		public CatchFormalParameterContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitCatchFormalParameter(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final CatchFormalParameterContext catchFormalParameter() throws RecognitionException {
		final CatchFormalParameterContext _localctx = new CatchFormalParameterContext(_ctx, getState());
		enterRule(_localctx, 338, Java8Parser.RULE_catchFormalParameter);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class CatchTypeContext extends ParserRuleContext {
		...
		public ClassTypeContext classType(final int i) {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitCatchType(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final CatchTypeContext catchType() throws RecognitionException {
		...
		enterRule(_localctx, 340, Java8Parser.RULE_catchType);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class Finally_Context extends ParserRuleContext {
		...
		public Finally_Context(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitFinally_(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final Finally_Context finally_() throws RecognitionException {
		final Finally_Context _localctx = new Finally_Context(_ctx, getState());
		enterRule(_localctx, 342, Java8Parser.RULE_finally_);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(1824);
	...
	public static class TryWithResourcesStatementContext extends ParserRuleContext {
		...
		public TryWithResourcesStatementContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTryWithResourcesStatement(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TryWithResourcesStatementContext tryWithResourcesStatement() throws RecognitionException {
		final TryWithResourcesStatementContext _localctx = new TryWithResourcesStatementContext(_ctx, getState());
		enterRule(_localctx, 344, Java8Parser.RULE_tryWithResourcesStatement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ResourceSpecificationContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitResourceSpecification(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ResourceSpecificationContext resourceSpecification() throws RecognitionException {
		...
		enterRule(_localctx, 346, Java8Parser.RULE_resourceSpecification);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ResourceListContext extends ParserRuleContext {
		...
		public ResourceListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitResourceList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ResourceListContext resourceList() throws RecognitionException {
		final ResourceListContext _localctx = new ResourceListContext(_ctx, getState());
		enterRule(_localctx, 348, Java8Parser.RULE_resourceList);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ResourceContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitResource(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ResourceContext resource() throws RecognitionException {
		...
		enterRule(_localctx, 350, Java8Parser.RULE_resource);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class PrimaryContext extends ParserRuleContext {
		...
		public PrimaryNoNewArray_lf_primaryContext primaryNoNewArray_lf_primary(final int i) {
	...
	public final PrimaryContext primary() throws RecognitionException {
		...
		enterRule(_localctx, 352, Java8Parser.RULE_primary);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class PrimaryNoNewArrayContext extends ParserRuleContext {
		...
		public PrimaryNoNewArrayContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPrimaryNoNewArray(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PrimaryNoNewArrayContext primaryNoNewArray() throws RecognitionException {
		final PrimaryNoNewArrayContext _localctx = new PrimaryNoNewArrayContext(_ctx, getState());
		enterRule(_localctx, 354, Java8Parser.RULE_primaryNoNewArray);
		int _la;
		try {
			setState(1901);
	...
	public static class PrimaryNoNewArray_lf_arrayAccessContext extends ParserRuleContext {
		...
		public PrimaryNoNewArray_lf_arrayAccessContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPrimaryNoNewArray_lf_arrayAccess(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PrimaryNoNewArray_lf_arrayAccessContext primaryNoNewArray_lf_arrayAccess()
			throws RecognitionException {
		final PrimaryNoNewArray_lf_arrayAccessContext _localctx = new PrimaryNoNewArray_lf_arrayAccessContext(_ctx,
				getState());
		enterRule(_localctx, 356, Java8Parser.RULE_primaryNoNewArray_lf_arrayAccess);
		try {
			enterOuterAlt(_localctx, 1);
			{
			}
	...
	public static class PrimaryNoNewArray_lfno_arrayAccessContext extends ParserRuleContext {
		...
		public PrimaryNoNewArray_lfno_arrayAccessContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPrimaryNoNewArray_lfno_arrayAccess(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PrimaryNoNewArray_lfno_arrayAccessContext primaryNoNewArray_lfno_arrayAccess()
			throws RecognitionException {
		final PrimaryNoNewArray_lfno_arrayAccessContext _localctx = new PrimaryNoNewArray_lfno_arrayAccessContext(_ctx,
				getState());
		enterRule(_localctx, 358, Java8Parser.RULE_primaryNoNewArray_lfno_arrayAccess);
		int _la;
		try {
			setState(1933);
	...
	public static class PrimaryNoNewArray_lf_primaryContext extends ParserRuleContext {
		...
		public PrimaryNoNewArray_lf_primaryContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPrimaryNoNewArray_lf_primary(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PrimaryNoNewArray_lf_primaryContext primaryNoNewArray_lf_primary() throws RecognitionException {
		final PrimaryNoNewArray_lf_primaryContext _localctx = new PrimaryNoNewArray_lf_primaryContext(_ctx, getState());
		enterRule(_localctx, 360, Java8Parser.RULE_primaryNoNewArray_lf_primary);
		try {
			setState(1940);
	...
	public static class PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext extends ParserRuleContext {
		...
		public PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext(final ParserRuleContext parent,
				final int invokingState) {
			super(parent, invokingState);
		}
	...
	public final PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext primaryNoNewArray_lf_primary_lf_arrayAccess_lf_primary()
			throws RecognitionException {
		final PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext _localctx = new PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext(
				_ctx, getState());
		enterRule(_localctx, 362, Java8Parser.RULE_primaryNoNewArray_lf_primary_lf_arrayAccess_lf_primary);
		try {
			enterOuterAlt(_localctx, 1);
			{
			}
	...
	public static class PrimaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primaryContext extends ParserRuleContext {
		...
		public PrimaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primaryContext(final ParserRuleContext parent,
				final int invokingState) {
			super(parent, invokingState);
		}
	...
	public final PrimaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primaryContext primaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primary()
			throws RecognitionException {
		final PrimaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primaryContext _localctx = new PrimaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primaryContext(
				_ctx, getState());
		enterRule(_localctx, 364, Java8Parser.RULE_primaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primary);
		try {
			setState(1948);
	...
	public static class PrimaryNoNewArray_lfno_primaryContext extends ParserRuleContext {
		...
		public PrimaryNoNewArray_lfno_primaryContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPrimaryNoNewArray_lfno_primary(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PrimaryNoNewArray_lfno_primaryContext primaryNoNewArray_lfno_primary() throws RecognitionException {
		final PrimaryNoNewArray_lfno_primaryContext _localctx = new PrimaryNoNewArray_lfno_primaryContext(_ctx,
				getState());
		enterRule(_localctx, 366, Java8Parser.RULE_primaryNoNewArray_lfno_primary);
		int _la;
		try {
			setState(1990);
	...
	public static class PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext extends ParserRuleContext {
		...
		public PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext(final ParserRuleContext parent,
				final int invokingState) {
			super(parent, invokingState);
		}
	...
	public final PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext primaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primary()
			throws RecognitionException {
		final PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext _localctx = new PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext(
				_ctx, getState());
		enterRule(_localctx, 368, Java8Parser.RULE_primaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primary);
		try {
			enterOuterAlt(_localctx, 1);
			{
			}
	...
	public static class PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primaryContext extends ParserRuleContext {
		...
		public PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primaryContext(final ParserRuleContext parent,
				final int invokingState) {
			super(parent, invokingState);
		}
	...
	public final PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primaryContext primaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primary()
			throws RecognitionException {
		final PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primaryContext _localctx = new PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primaryContext(
				_ctx, getState());
		enterRule(_localctx, 370, Java8Parser.RULE_primaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primary);
		int _la;
		try {
			setState(2033);
	...
	public static class ClassInstanceCreationExpressionContext extends ParserRuleContext {
		...
		public ClassInstanceCreationExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitClassInstanceCreationExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ClassInstanceCreationExpressionContext classInstanceCreationExpression() throws RecognitionException {
		final ClassInstanceCreationExpressionContext _localctx = new ClassInstanceCreationExpressionContext(_ctx,
				getState());
		enterRule(_localctx, 372, Java8Parser.RULE_classInstanceCreationExpression);
		int _la;
		try {
			setState(2118);
	...
	public static class ClassInstanceCreationExpression_lf_primaryContext extends ParserRuleContext {
		...
		public ClassInstanceCreationExpression_lf_primaryContext(final ParserRuleContext parent,
				final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitClassInstanceCreationExpression_lf_primary(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ClassInstanceCreationExpression_lf_primaryContext classInstanceCreationExpression_lf_primary()
			throws RecognitionException {
		final ClassInstanceCreationExpression_lf_primaryContext _localctx = new ClassInstanceCreationExpression_lf_primaryContext(
				_ctx, getState());
		enterRule(_localctx, 374, Java8Parser.RULE_classInstanceCreationExpression_lf_primary);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ClassInstanceCreationExpression_lfno_primaryContext extends ParserRuleContext {
		...
		public ClassInstanceCreationExpression_lfno_primaryContext(final ParserRuleContext parent,
				final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitClassInstanceCreationExpression_lfno_primary(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ClassInstanceCreationExpression_lfno_primaryContext classInstanceCreationExpression_lfno_primary()
			throws RecognitionException {
		final ClassInstanceCreationExpression_lfno_primaryContext _localctx = new ClassInstanceCreationExpression_lfno_primaryContext(
				_ctx, getState());
		enterRule(_localctx, 376, Java8Parser.RULE_classInstanceCreationExpression_lfno_primary);
		int _la;
		try {
			setState(2202);
			switch (_input.LA(1)) {
	...
	public static class TypeArgumentsOrDiamondContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitTypeArgumentsOrDiamond(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final TypeArgumentsOrDiamondContext typeArgumentsOrDiamond() throws RecognitionException {
		...
		enterRule(_localctx, 378, Java8Parser.RULE_typeArgumentsOrDiamond);
		try {
			setState(2207);
	...
	public static class FieldAccessContext extends ParserRuleContext {
		...
		public FieldAccessContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitFieldAccess(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final FieldAccessContext fieldAccess() throws RecognitionException {
		final FieldAccessContext _localctx = new FieldAccessContext(_ctx, getState());
		enterRule(_localctx, 380, Java8Parser.RULE_fieldAccess);
		try {
			setState(2222);
	...
	public static class FieldAccess_lf_primaryContext extends ParserRuleContext {
		...
		public FieldAccess_lf_primaryContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitFieldAccess_lf_primary(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final FieldAccess_lf_primaryContext fieldAccess_lf_primary() throws RecognitionException {
		final FieldAccess_lf_primaryContext _localctx = new FieldAccess_lf_primaryContext(_ctx, getState());
		enterRule(_localctx, 382, Java8Parser.RULE_fieldAccess_lf_primary);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(2224);
	...
	public static class FieldAccess_lfno_primaryContext extends ParserRuleContext {
		...
		public FieldAccess_lfno_primaryContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitFieldAccess_lfno_primary(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final FieldAccess_lfno_primaryContext fieldAccess_lfno_primary() throws RecognitionException {
		final FieldAccess_lfno_primaryContext _localctx = new FieldAccess_lfno_primaryContext(_ctx, getState());
		enterRule(_localctx, 384, Java8Parser.RULE_fieldAccess_lfno_primary);
		try {
			setState(2236);
			switch (_input.LA(1)) {
			case SUPER:
	...
	public static class ArrayAccessContext extends ParserRuleContext {
		...
		public PrimaryNoNewArray_lf_arrayAccessContext primaryNoNewArray_lf_arrayAccess(final int i) {
			return getRuleContext(PrimaryNoNewArray_lf_arrayAccessContext.class, i);
		}

		public ArrayAccessContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitArrayAccess(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ArrayAccessContext arrayAccess() throws RecognitionException {
		final ArrayAccessContext _localctx = new ArrayAccessContext(_ctx, getState());
		enterRule(_localctx, 386, Java8Parser.RULE_arrayAccess);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ArrayAccess_lf_primaryContext extends ParserRuleContext {
		...
		public ArrayAccess_lf_primaryContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitArrayAccess_lf_primary(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ArrayAccess_lf_primaryContext arrayAccess_lf_primary() throws RecognitionException {
		final ArrayAccess_lf_primaryContext _localctx = new ArrayAccess_lf_primaryContext(_ctx, getState());
		enterRule(_localctx, 388, Java8Parser.RULE_arrayAccess_lf_primary);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ArrayAccess_lfno_primaryContext extends ParserRuleContext {
		...
		public ArrayAccess_lfno_primaryContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitArrayAccess_lfno_primary(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ArrayAccess_lfno_primaryContext arrayAccess_lfno_primary() throws RecognitionException {
		final ArrayAccess_lfno_primaryContext _localctx = new ArrayAccess_lfno_primaryContext(_ctx, getState());
		enterRule(_localctx, 390, Java8Parser.RULE_arrayAccess_lfno_primary);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class MethodInvocationContext extends ParserRuleContext {
		...
		public MethodInvocationContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMethodInvocation(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MethodInvocationContext methodInvocation() throws RecognitionException {
		final MethodInvocationContext _localctx = new MethodInvocationContext(_ctx, getState());
		enterRule(_localctx, 392, Java8Parser.RULE_methodInvocation);
		int _la;
		try {
			setState(2365);
	...
	public static class MethodInvocation_lf_primaryContext extends ParserRuleContext {
		...
		public MethodInvocation_lf_primaryContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMethodInvocation_lf_primary(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MethodInvocation_lf_primaryContext methodInvocation_lf_primary() throws RecognitionException {
		final MethodInvocation_lf_primaryContext _localctx = new MethodInvocation_lf_primaryContext(_ctx, getState());
		enterRule(_localctx, 394, Java8Parser.RULE_methodInvocation_lf_primary);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class MethodInvocation_lfno_primaryContext extends ParserRuleContext {
		...
		public MethodInvocation_lfno_primaryContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMethodInvocation_lfno_primary(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MethodInvocation_lfno_primaryContext methodInvocation_lfno_primary() throws RecognitionException {
		final MethodInvocation_lfno_primaryContext _localctx = new MethodInvocation_lfno_primaryContext(_ctx,
				getState());
		enterRule(_localctx, 396, Java8Parser.RULE_methodInvocation_lfno_primary);
		int _la;
		try {
			setState(2434);
	...
	public static class ArgumentListContext extends ParserRuleContext {
		...
		public ArgumentListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitArgumentList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ArgumentListContext argumentList() throws RecognitionException {
		final ArgumentListContext _localctx = new ArgumentListContext(_ctx, getState());
		enterRule(_localctx, 398, Java8Parser.RULE_argumentList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class MethodReferenceContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMethodReference(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MethodReferenceContext methodReference() throws RecognitionException {
		...
		enterRule(_localctx, 400, Java8Parser.RULE_methodReference);
		int _la;
		try {
			setState(2491);
	...
	public static class MethodReference_lf_primaryContext extends ParserRuleContext {
		...
		public MethodReference_lf_primaryContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMethodReference_lf_primary(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MethodReference_lf_primaryContext methodReference_lf_primary() throws RecognitionException {
		final MethodReference_lf_primaryContext _localctx = new MethodReference_lf_primaryContext(_ctx, getState());
		enterRule(_localctx, 402, Java8Parser.RULE_methodReference_lf_primary);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class MethodReference_lfno_primaryContext extends ParserRuleContext {
		...
		public MethodReference_lfno_primaryContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMethodReference_lfno_primary(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final MethodReference_lfno_primaryContext methodReference_lfno_primary() throws RecognitionException {
		final MethodReference_lfno_primaryContext _localctx = new MethodReference_lfno_primaryContext(_ctx, getState());
		enterRule(_localctx, 404, Java8Parser.RULE_methodReference_lfno_primary);
		int _la;
		try {
			setState(2539);
	...
	public static class ArrayCreationExpressionContext extends ParserRuleContext {
		...
		public ArrayCreationExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitArrayCreationExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ArrayCreationExpressionContext arrayCreationExpression() throws RecognitionException {
		final ArrayCreationExpressionContext _localctx = new ArrayCreationExpressionContext(_ctx, getState());
		enterRule(_localctx, 406, Java8Parser.RULE_arrayCreationExpression);
		try {
			setState(2563);
	...
	public static class DimExprsContext extends ParserRuleContext {
		...
		public DimExprContext dimExpr(final int i) {
			return getRuleContext(DimExprContext.class, i);
		}

		public DimExprsContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitDimExprs(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final DimExprsContext dimExprs() throws RecognitionException {
		final DimExprsContext _localctx = new DimExprsContext(_ctx, getState());
		enterRule(_localctx, 408, Java8Parser.RULE_dimExprs);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class DimExprContext extends ParserRuleContext {
		...
		public DimExprContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
	...
	public final DimExprContext dimExpr() throws RecognitionException {
		final DimExprContext _localctx = new DimExprContext(_ctx, getState());
		enterRule(_localctx, 410, Java8Parser.RULE_dimExpr);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ConstantExpressionContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitConstantExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ConstantExpressionContext constantExpression() throws RecognitionException {
		...
		enterRule(_localctx, 412, Java8Parser.RULE_constantExpression);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(2582);
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		enterRule(_localctx, 414, Java8Parser.RULE_expression);
		try {
			setState(2586);
	...
	public static class LambdaExpressionContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitLambdaExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final LambdaExpressionContext lambdaExpression() throws RecognitionException {
		...
		enterRule(_localctx, 416, Java8Parser.RULE_lambdaExpression);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(2588);
	...
	public static class LambdaParametersContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitLambdaParameters(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final LambdaParametersContext lambdaParameters() throws RecognitionException {
		...
		enterRule(_localctx, 418, Java8Parser.RULE_lambdaParameters);
		int _la;
		try {
			setState(2602);
	...
	public static class InferredFormalParameterListContext extends ParserRuleContext {
		...
		public InferredFormalParameterListContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInferredFormalParameterList(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final InferredFormalParameterListContext inferredFormalParameterList() throws RecognitionException {
		final InferredFormalParameterListContext _localctx = new InferredFormalParameterListContext(_ctx, getState());
		enterRule(_localctx, 420, Java8Parser.RULE_inferredFormalParameterList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class LambdaBodyContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitLambdaBody(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final LambdaBodyContext lambdaBody() throws RecognitionException {
		...
		enterRule(_localctx, 422, Java8Parser.RULE_lambdaBody);
		try {
			setState(2614);
			switch (_input.LA(1)) {
			case BOOLEAN:
	...
	public static class AssignmentExpressionContext extends ParserRuleContext {
		...
		public AssignmentExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAssignmentExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final AssignmentExpressionContext assignmentExpression() throws RecognitionException {
		final AssignmentExpressionContext _localctx = new AssignmentExpressionContext(_ctx, getState());
		enterRule(_localctx, 424, Java8Parser.RULE_assignmentExpression);
		try {
			setState(2618);
	...
	public static class AssignmentContext extends ParserRuleContext {
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAssignment(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final AssignmentContext assignment() throws RecognitionException {
		...
		enterRule(_localctx, 426, Java8Parser.RULE_assignment);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(2620);
	...
	public static class LeftHandSideContext extends ParserRuleContext {
		...
		public LeftHandSideContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitLeftHandSide(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final LeftHandSideContext leftHandSide() throws RecognitionException {
		final LeftHandSideContext _localctx = new LeftHandSideContext(_ctx, getState());
		enterRule(_localctx, 428, Java8Parser.RULE_leftHandSide);
		try {
			setState(2627);
	...
	public static class AssignmentOperatorContext extends ParserRuleContext {
		...
		public AssignmentOperatorContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAssignmentOperator(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final AssignmentOperatorContext assignmentOperator() throws RecognitionException {
		final AssignmentOperatorContext _localctx = new AssignmentOperatorContext(_ctx, getState());
		enterRule(_localctx, 430, Java8Parser.RULE_assignmentOperator);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(2629);
				_la = _input.LA(1);
				if (!((_la - 66 & ~0x3f) == 0 && (1L << _la - 66 & (1L << Java8Parser.ASSIGN - 66
						| 1L << Java8Parser.ADD_ASSIGN - 66 | 1L << Java8Parser.SUB_ASSIGN - 66
						| 1L << Java8Parser.MUL_ASSIGN - 66 | 1L << Java8Parser.DIV_ASSIGN - 66
						| 1L << Java8Parser.AND_ASSIGN - 66 | 1L << Java8Parser.OR_ASSIGN - 66
						| 1L << Java8Parser.XOR_ASSIGN - 66 | 1L << Java8Parser.MOD_ASSIGN - 66
						| 1L << Java8Parser.LSHIFT_ASSIGN - 66 | 1L << Java8Parser.RSHIFT_ASSIGN - 66
						| 1L << Java8Parser.URSHIFT_ASSIGN - 66)) != 0)) {
					_errHandler.recoverInline(this);
				} else {
					consume();
				}
	...
	public static class ConditionalExpressionContext extends ParserRuleContext {
		...
		public ConditionalExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitConditionalExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final ConditionalExpressionContext conditionalExpression() throws RecognitionException {
		final ConditionalExpressionContext _localctx = new ConditionalExpressionContext(_ctx, getState());
		enterRule(_localctx, 432, Java8Parser.RULE_conditionalExpression);
		try {
			setState(2638);
	...
	public static class ConditionalOrExpressionContext extends ParserRuleContext {
		...
		public ConditionalOrExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitConditionalOrExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private ConditionalOrExpressionContext conditionalOrExpression(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		ConditionalOrExpressionContext _localctx = new ConditionalOrExpressionContext(_ctx, _parentState);
		ConditionalOrExpressionContext _prevctx = _localctx;
		final int _startState = 434;
		enterRecursionRule(_localctx, 434, Java8Parser.RULE_conditionalOrExpression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ConditionalAndExpressionContext extends ParserRuleContext {
		...
		public ConditionalAndExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitConditionalAndExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private ConditionalAndExpressionContext conditionalAndExpression(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		ConditionalAndExpressionContext _localctx = new ConditionalAndExpressionContext(_ctx, _parentState);
		ConditionalAndExpressionContext _prevctx = _localctx;
		final int _startState = 436;
		enterRecursionRule(_localctx, 436, Java8Parser.RULE_conditionalAndExpression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class InclusiveOrExpressionContext extends ParserRuleContext {
		...
		public InclusiveOrExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitInclusiveOrExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private InclusiveOrExpressionContext inclusiveOrExpression(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		InclusiveOrExpressionContext _localctx = new InclusiveOrExpressionContext(_ctx, _parentState);
		InclusiveOrExpressionContext _prevctx = _localctx;
		final int _startState = 438;
		enterRecursionRule(_localctx, 438, Java8Parser.RULE_inclusiveOrExpression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
						...
						{
							{
								...
								pushNewRecursionContext(_localctx, _startState, Java8Parser.RULE_inclusiveOrExpression);
								setState(2665);
								if (!precpred(_ctx, 1)) {
									throw new FailedPredicateException(this, "precpred(_ctx, 1)");
								}
	...
	public static class ExclusiveOrExpressionContext extends ParserRuleContext {
		...
		public ExclusiveOrExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitExclusiveOrExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private ExclusiveOrExpressionContext exclusiveOrExpression(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		ExclusiveOrExpressionContext _localctx = new ExclusiveOrExpressionContext(_ctx, _parentState);
		ExclusiveOrExpressionContext _prevctx = _localctx;
		final int _startState = 440;
		enterRecursionRule(_localctx, 440, Java8Parser.RULE_exclusiveOrExpression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
						...
						{
							{
								...
								pushNewRecursionContext(_localctx, _startState, Java8Parser.RULE_exclusiveOrExpression);
								setState(2676);
								if (!precpred(_ctx, 1)) {
									throw new FailedPredicateException(this, "precpred(_ctx, 1)");
								}
	...
	public static class AndExpressionContext extends ParserRuleContext {
		...
		public AndExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAndExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private AndExpressionContext andExpression(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		AndExpressionContext _localctx = new AndExpressionContext(_ctx, _parentState);
		AndExpressionContext _prevctx = _localctx;
		final int _startState = 442;
		enterRecursionRule(_localctx, 442, Java8Parser.RULE_andExpression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
						...
						{
							{
								...
								pushNewRecursionContext(_localctx, _startState, Java8Parser.RULE_andExpression);
								setState(2687);
								if (!precpred(_ctx, 1)) {
									throw new FailedPredicateException(this, "precpred(_ctx, 1)");
								}
	...
	public static class EqualityExpressionContext extends ParserRuleContext {
		...
		public EqualityExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitEqualityExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private EqualityExpressionContext equalityExpression(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		EqualityExpressionContext _localctx = new EqualityExpressionContext(_ctx, _parentState);
		EqualityExpressionContext _prevctx = _localctx;
		final int _startState = 444;
		enterRecursionRule(_localctx, 444, Java8Parser.RULE_equalityExpression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
					...
					if (_alt == 1) {
						...
						_prevctx = _localctx;
						{
							...
							case 1: {
								...
								pushNewRecursionContext(_localctx, _startState, Java8Parser.RULE_equalityExpression);
								setState(2698);
								if (!precpred(_ctx, 2)) {
	...
	public static class RelationalExpressionContext extends ParserRuleContext {
		...
		public RelationalExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitRelationalExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private RelationalExpressionContext relationalExpression(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		RelationalExpressionContext _localctx = new RelationalExpressionContext(_ctx, _parentState);
		RelationalExpressionContext _prevctx = _localctx;
		final int _startState = 446;
		enterRecursionRule(_localctx, 446, Java8Parser.RULE_relationalExpression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
					...
					if (_alt == 1) {
						...
						_prevctx = _localctx;
						{
							...
							case 1: {
								...
								pushNewRecursionContext(_localctx, _startState, Java8Parser.RULE_relationalExpression);
								setState(2712);
								if (!precpred(_ctx, 5)) {
	...
	public static class ShiftExpressionContext extends ParserRuleContext {
		...
		public ShiftExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitShiftExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private ShiftExpressionContext shiftExpression(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		ShiftExpressionContext _localctx = new ShiftExpressionContext(_ctx, _parentState);
		ShiftExpressionContext _prevctx = _localctx;
		final int _startState = 448;
		enterRecursionRule(_localctx, 448, Java8Parser.RULE_shiftExpression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
					...
					if (_alt == 1) {
						...
						_prevctx = _localctx;
						{
							...
							case 1: {
								...
								pushNewRecursionContext(_localctx, _startState, Java8Parser.RULE_shiftExpression);
								setState(2735);
								if (!precpred(_ctx, 3)) {
									throw new FailedPredicateException(this, "precpred(_ctx, 3)");
								}
	...
	public static class AdditiveExpressionContext extends ParserRuleContext {
		...
		public AdditiveExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitAdditiveExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private AdditiveExpressionContext additiveExpression(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		AdditiveExpressionContext _localctx = new AdditiveExpressionContext(_ctx, _parentState);
		AdditiveExpressionContext _prevctx = _localctx;
		final int _startState = 450;
		enterRecursionRule(_localctx, 450, Java8Parser.RULE_additiveExpression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
					...
					if (_alt == 1) {
						...
						_prevctx = _localctx;
						{
							...
							case 1: {
								...
								pushNewRecursionContext(_localctx, _startState, Java8Parser.RULE_additiveExpression);
								setState(2756);
								if (!precpred(_ctx, 2)) {
									throw new FailedPredicateException(this, "precpred(_ctx, 2)");
								}
	...
	public static class MultiplicativeExpressionContext extends ParserRuleContext {
		...
		public MultiplicativeExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitMultiplicativeExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	private MultiplicativeExpressionContext multiplicativeExpression(final int _p) throws RecognitionException {
		final ParserRuleContext _parentctx = _ctx;
		final int _parentState = getState();
		MultiplicativeExpressionContext _localctx = new MultiplicativeExpressionContext(_ctx, _parentState);
		MultiplicativeExpressionContext _prevctx = _localctx;
		final int _startState = 452;
		enterRecursionRule(_localctx, 452, Java8Parser.RULE_multiplicativeExpression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class UnaryExpressionContext extends ParserRuleContext {
		...
		public UnaryExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnaryExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnaryExpressionContext unaryExpression() throws RecognitionException {
		final UnaryExpressionContext _localctx = new UnaryExpressionContext(_ctx, getState());
		enterRule(_localctx, 454, Java8Parser.RULE_unaryExpression);
		try {
			setState(2791);
			switch (_input.LA(1)) {
			case INC:
	...
	public static class PreIncrementExpressionContext extends ParserRuleContext {
		...
		public PreIncrementExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPreIncrementExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PreIncrementExpressionContext preIncrementExpression() throws RecognitionException {
		final PreIncrementExpressionContext _localctx = new PreIncrementExpressionContext(_ctx, getState());
		enterRule(_localctx, 456, Java8Parser.RULE_preIncrementExpression);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(2793);
	...
	public static class PreDecrementExpressionContext extends ParserRuleContext {
		...
		public PreDecrementExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPreDecrementExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PreDecrementExpressionContext preDecrementExpression() throws RecognitionException {
		final PreDecrementExpressionContext _localctx = new PreDecrementExpressionContext(_ctx, getState());
		enterRule(_localctx, 458, Java8Parser.RULE_preDecrementExpression);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(2796);
	...
	public static class UnaryExpressionNotPlusMinusContext extends ParserRuleContext {
		...
		public UnaryExpressionNotPlusMinusContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitUnaryExpressionNotPlusMinus(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final UnaryExpressionNotPlusMinusContext unaryExpressionNotPlusMinus() throws RecognitionException {
		final UnaryExpressionNotPlusMinusContext _localctx = new UnaryExpressionNotPlusMinusContext(_ctx, getState());
		enterRule(_localctx, 460, Java8Parser.RULE_unaryExpressionNotPlusMinus);
		try {
			setState(2805);
	...
	public static class PostfixExpressionContext extends ParserRuleContext {
		...
		public PostfixExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPostfixExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PostfixExpressionContext postfixExpression() throws RecognitionException {
		final PostfixExpressionContext _localctx = new PostfixExpressionContext(_ctx, getState());
		enterRule(_localctx, 462, Java8Parser.RULE_postfixExpression);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class PostIncrementExpressionContext extends ParserRuleContext {
		...
		public PostIncrementExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPostIncrementExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PostIncrementExpressionContext postIncrementExpression() throws RecognitionException {
		final PostIncrementExpressionContext _localctx = new PostIncrementExpressionContext(_ctx, getState());
		enterRule(_localctx, 464, Java8Parser.RULE_postIncrementExpression);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(2818);
	...
	public static class PostIncrementExpression_lf_postfixExpressionContext extends ParserRuleContext {
		...
		public PostIncrementExpression_lf_postfixExpressionContext(final ParserRuleContext parent,
				final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPostIncrementExpression_lf_postfixExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PostIncrementExpression_lf_postfixExpressionContext postIncrementExpression_lf_postfixExpression()
			throws RecognitionException {
		final PostIncrementExpression_lf_postfixExpressionContext _localctx = new PostIncrementExpression_lf_postfixExpressionContext(
				_ctx, getState());
		enterRule(_localctx, 466, Java8Parser.RULE_postIncrementExpression_lf_postfixExpression);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(2821);
	...
	public static class PostDecrementExpressionContext extends ParserRuleContext {
		...
		public PostDecrementExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPostDecrementExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PostDecrementExpressionContext postDecrementExpression() throws RecognitionException {
		final PostDecrementExpressionContext _localctx = new PostDecrementExpressionContext(_ctx, getState());
		enterRule(_localctx, 468, Java8Parser.RULE_postDecrementExpression);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(2823);
	...
	public static class PostDecrementExpression_lf_postfixExpressionContext extends ParserRuleContext {
		...
		public PostDecrementExpression_lf_postfixExpressionContext(final ParserRuleContext parent,
				final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitPostDecrementExpression_lf_postfixExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final PostDecrementExpression_lf_postfixExpressionContext postDecrementExpression_lf_postfixExpression()
			throws RecognitionException {
		final PostDecrementExpression_lf_postfixExpressionContext _localctx = new PostDecrementExpression_lf_postfixExpressionContext(
				_ctx, getState());
		enterRule(_localctx, 470, Java8Parser.RULE_postDecrementExpression_lf_postfixExpression);
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(2826);
	...
	public static class CastExpressionContext extends ParserRuleContext {
		...
		public CastExpressionContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(final ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof Java8Visitor) {
				return ((Java8Visitor<? extends T>) visitor).visitCastExpression(this);
			} else {
				return visitor.visitChildren(this);
			}
		}
	...
	public final CastExpressionContext castExpression() throws RecognitionException {
		final CastExpressionContext _localctx = new CastExpressionContext(_ctx, getState());
		enterRule(_localctx, 472, Java8Parser.RULE_castExpression);
		int _la;
		try {
			setState(2855);
	...
	private boolean packageName_sempred(final PackageNameContext _localctx, final int predIndex) {
		switch (predIndex) {
		case 0:
	...
	private boolean packageOrTypeName_sempred(final PackageOrTypeNameContext _localctx, final int predIndex) {
		switch (predIndex) {
		case 1:
			return precpred(_ctx, 1);
		}
	...
	private boolean ambiguousName_sempred(final AmbiguousNameContext _localctx, final int predIndex) {
		switch (predIndex) {
		case 2:
			return precpred(_ctx, 1);
		}
	...
	private boolean conditionalOrExpression_sempred(final ConditionalOrExpressionContext _localctx,
			final int predIndex) {
		switch (predIndex) {
		case 3:
			return precpred(_ctx, 1);
	...
	private boolean conditionalAndExpression_sempred(final ConditionalAndExpressionContext _localctx,
			final int predIndex) {
		switch (predIndex) {
		case 4:
			return precpred(_ctx, 1);
	...
	private boolean inclusiveOrExpression_sempred(final InclusiveOrExpressionContext _localctx, final int predIndex) {
		switch (predIndex) {
		case 5:
			return precpred(_ctx, 1);
		}
	...
	private boolean exclusiveOrExpression_sempred(final ExclusiveOrExpressionContext _localctx, final int predIndex) {
		switch (predIndex) {
		case 6:
			return precpred(_ctx, 1);
		}
	...
	private boolean andExpression_sempred(final AndExpressionContext _localctx, final int predIndex) {
		switch (predIndex) {
		case 7:
			return precpred(_ctx, 1);
		}
	...
	private boolean equalityExpression_sempred(final EqualityExpressionContext _localctx, final int predIndex) {
		switch (predIndex) {
		case 8:
	...
	private boolean relationalExpression_sempred(final RelationalExpressionContext _localctx, final int predIndex) {
		switch (predIndex) {
		case 10:
	...
	private boolean shiftExpression_sempred(final ShiftExpressionContext _localctx, final int predIndex) {
		switch (predIndex) {
		case 15:
			return precpred(_ctx, 3);
		case 16:
	...
	private boolean additiveExpression_sempred(final AdditiveExpressionContext _localctx, final int predIndex) {
		switch (predIndex) {
		case 18:
			return precpred(_ctx, 2);
		case 19:
	...
	private boolean multiplicativeExpression_sempred(final MultiplicativeExpressionContext _localctx,
			final int predIndex) {
		switch (predIndex) {
		case 20:
			return precpred(_ctx, 3);
	...
	private static final String _serializedATNSegment0 = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3m\u0b2c\4\2\t\2\4"
			...
			+ "\3\2\2\2\u0968\u0969\3\2\2\2\u0969\u096a\7<\2\2\u096a\u0985\3\2\2\2\u096b" + "\u096c\7*";
	private static final String _serializedATNSegment1 = "\2\2\u096c\u096e\7C\2\2\u096d\u096f\5,\27\2\u096e\u096d\3\2\2\2\u096e"
	...
	public static final String _serializedATN = Utils
			.join(new String[] { Java8Parser._serializedATNSegment0, Java8Parser._serializedATNSegment1 }, "");
	public static final ATN _ATN = new ATNDeserializer().deserialize(Java8Parser._serializedATN.toCharArray());

	static {
		_decisionToDFA = new DFA[Java8Parser._ATN.getNumberOfDecisions()];
		for (int i = 0; i < Java8Parser._ATN.getNumberOfDecisions(); i++) {
			Java8Parser._decisionToDFA[i] = new DFA(Java8Parser._ATN.getDecisionState(i), i);
		}
	}
}