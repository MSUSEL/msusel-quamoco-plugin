...
public class GradeThresholdExceptionTest {
	...
	public void testGradeThresholdException_1() throws Exception {
		...
		Assert.assertEquals("net.siliconcode.quamoco.distiller.GradeThresholdException", result.toString());
	...
	public void testGradeThresholdException_3() throws Exception {
		...
		// TODO: add additional test code here
		Assert.assertNotNull(result);
		Assert.assertEquals("net.siliconcode.quamoco.distiller.GradeThresholdException: java.lang.Throwable",
				result.toString());
