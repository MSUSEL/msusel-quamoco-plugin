...
/**
 * The class <code>SingleMeasureEvaluationStrategyTest</code> contains tests for the class <code>{@link SingleMeasureEvaluationStrategy}</code>.
 *
 * @generatedBy CodePro at 5/30/15 3:43 PM
 * @author isaac
 * @version $Revision: 1.0 $
 */
public class SingleMeasureEvaluationStrategyTest {
    /**
     * Run the SingleMeasureEvaluationStrategy(NormalizationStrategy) constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 5/30/15 3:43 PM
     */
    @Test
    public void testSingleMeasureEvaluationStrategy_1()
        throws Exception
    {
        ...
        SingleMeasureEvaluationStrategy result = new SingleMeasureEvaluationStrategy(ns);
    ...
    {
        new org.junit.runner.JUnitCore().run(SingleMeasureEvaluationStrategyTest.class);
    }
}