...
public class RootNotFoundExceptionTest {
	...
	public void testRootNotFoundException_1() throws Exception {
		...
		Assert.assertEquals("net.siliconcode.quamoco.io.RootNotFoundException", result.toString());
	...
	public void testRootNotFoundException_3() throws Exception {
		...
		// TODO: add additional test code here
		Assert.assertNotNull(result);
		Assert.assertEquals("net.siliconcode.quamoco.io.RootNotFoundException: java.lang.Throwable", result.toString());
