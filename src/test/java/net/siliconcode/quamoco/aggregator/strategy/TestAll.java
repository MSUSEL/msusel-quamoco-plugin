...
@Suite.SuiteClasses({
    ...
    NumberAggregationStrategyTest.class,
    NormalizationStrategyTest.class,
    NumberMinAggregationStrategyTest.class,
    WeightedSumFactorEvaluationStrategyTest.class,
    FindingsAggregationStrategyTest.class,
