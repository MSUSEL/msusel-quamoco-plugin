...
public class QMReaderTest {
	...
	public void testRead_1() throws Exception {
		...
		Assert.assertEquals(0.0, fn1.getLowerBound(), 0.00001);
		Assert.assertEquals(0.02115295067208891, fn1.getUpperBound(), 0.00001);
		...
		Assert.assertEquals(0.0, fn2.getLowerBound(), 0.00001);
		Assert.assertEquals(0.01254260186066505, fn2.getUpperBound(), 0.00001);
