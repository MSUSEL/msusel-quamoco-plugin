...
public class CSharp6PreProcessor extends Lexer {
	...
	public static final int Pp_directive = 1, BYTE_ORDER_MARK = 2, SINGLE_LINE_DOC_COMMENT = 3,
			...
			JOIN = 60, LET = 61, LOCK = 62, LONG = 63, NAMEOF = 64, NAMESPACE = 65, NEW = 66, NULL = 67, OBJECT = 68,
			ON = 69, OPERATOR = 70, ORDERBY = 71, OUT = 72, OVERRIDE = 73, PARAMS = 74, PARTIAL = 75, PRIVATE = 76,
			PROTECTED = 77, PUBLIC = 78, READONLY = 79, REF = 80, REMOVE = 81, RETURN = 82, SBYTE = 83, SEALED = 84,
			SELECT = 85, SET = 86, SHORT = 87, SIZEOF = 88, STACKALLOC = 89, STATIC = 90, STRING = 91, STRUCT = 92,
			SWITCH = 93, THIS = 94, THROW = 95, TRUE = 96, TRY = 97, TYPEOF = 98, UINT = 99, ULONG = 100,
			UNCHECKED = 101, UNSAFE = 102, USHORT = 103, USING = 104, VIRTUAL = 105, VOID = 106, VOLATILE = 107,
			WHEN = 108, WHERE = 109, WHILE = 110, YIELD = 111, IDENTIFIER = 112, INTEGER_LITERAL = 113,
			LiteralAccess = 114, REAL_LITERAL = 115, CHARACTER_LITERAL = 116, STRING_LITERAL = 117, OPEN_BRACE = 118,
			CLOSE_BRACE = 119, OPEN_BRACKET = 120, CLOSE_BRACKET = 121, OPEN_PARENS = 122, CLOSE_PARENS = 123,
			DOT = 124, COMMA = 125, COLON = 126, SEMICOLON = 127, PLUS = 128, MINUS = 129, STAR = 130, DIV = 131,
			PERCENT = 132, AMP = 133, BITWISE_OR = 134, CARET = 135, BANG = 136, TILDE = 137, ASSIGNMENT = 138,
			LT = 139, GT = 140, INTERR = 141, DOUBLE_COLON = 142, OP_COALESCING = 143, OP_INC = 144, OP_DEC = 145,
			OP_AND = 146, OP_OR = 147, OP_PTR = 148, OP_EQ = 149, OP_NE = 150, OP_LE = 151, OP_GE = 152,
			OP_ADD_ASSIGNMENT = 153, OP_SUB_ASSIGNMENT = 154, OP_MULT_ASSIGNMENT = 155, OP_DIV_ASSIGNMENT = 156,
			OP_MOD_ASSIGNMENT = 157, OP_AND_ASSIGNMENT = 158, OP_OR_ASSIGNMENT = 159, OP_XOR_ASSIGNMENT = 160,
			OP_LEFT_SHIFT = 161, OP_LEFT_SHIFT_ASSIGNMENT = 162, OP_STRING_INTERP = 163, QUOTE = 164,
			DOUBLE_QUOTE = 165, BACK_SLASH = 166, DOUBLE_BACK_SLASH = 167, SHARP = 168;
