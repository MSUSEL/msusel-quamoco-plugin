...
/**
 * The class <code>QuamocoBulletsWidgetTest</code> contains tests for the class <code>{@link QuamocoBulletsWidget}</code>.
 *
 * @generatedBy CodePro at 5/30/15 3:44 PM
 * @author isaac
 * @version $Revision: 1.0 $
 */
public class QuamocoBulletsWidgetTest {
    /**
     * Run the QuamocoBulletsWidget() constructor test.
     *
     * @generatedBy CodePro at 5/30/15 3:44 PM
     */
    @Test
    public void testQuamocoBulletsWidget_1()
        throws Exception
    {
    ...
    public void testGetId_1()
        throws Exception
    {
        QuamocoBulletsWidget fixture = new QuamocoBulletsWidget();
    ...
    {
        new org.junit.runner.JUnitCore().run(QuamocoBulletsWidgetTest.class);
    }
}