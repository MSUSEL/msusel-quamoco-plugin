...
import net.siliconcode.quamoco.aggregator.strategy.FindingsIntersectMeasureAggregationStrategy;
...
/**
 * The class <code>MeasureNodeTest</code> contains tests for the class <code>{@link MeasureNode}</code>.
 *
...
public class MeasureNodeTest {
    /**
     * Run the MeasureNode(DirectedSparseGraph<Node,Edge>,String,String) constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 5/30/15 3:38 PM
    ...
    /**
     * Run the MeasureNode(DirectedSparseGraph<Node,Edge>,String,String,long) constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 5/30/15 3:38 PM
        ...
        throws Exception
    {
        ...
        //       at net.siliconcode.quamoco.aggregator.graph.MeasureNode.getValue(MeasureNode.java:104)
     ...
     */
    @Test
    public void testIsNormalized_2()
        throws Exception
    {
        MeasureNode fixture = new MeasureNode(new DirectedSparseGraph(), "", "");
        fixture.setType("");
     ...
     */
    @Test
    public void testSetNormalized_1()
        throws Exception
    {
        MeasureNode fixture = new MeasureNode(new DirectedSparseGraph(), "", "");
        fixture.setType("");
