...
/**
 * The class <code>CSharpNumTypesTest</code> contains tests for the class <code>{@link CSharpNumTypes}</code>.
 *
 * @generatedBy CodePro at 5/30/15 3:48 PM
 * @author isaac
 * @version $Revision: 1.0 $
 */
public class CSharpNumTypesTest {
    /**
     * Run the Measure<Double> getTotalNOT(MetricContext) method test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 5/30/15 3:48 PM
        ...
        throws Exception
    {
        ...
        Measure<Double> result = CSharpNumTypes.getTotalNOT(metctx);

        // TODO: add additional test code here
        assertNotNull(result);
        assertEquals(null, result.getVariation5());
        assertEquals("quamoco.cs.#Types", result.getMetricKey());
    ...
    {
        new org.junit.runner.JUnitCore().run(CSharpNumTypesTest.class);
    }
}