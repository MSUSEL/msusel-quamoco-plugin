...
/**
 * The class <code>CSharpLOCTest</code> contains tests for the class <code>{@link CSharpLOC}</code>.
 *
 * @generatedBy CodePro at 5/30/15 3:48 PM
 * @author isaac
 * @version $Revision: 1.0 $
 */
public class CSharpLOCTest {
    /**
     * Run the Measure<Double> getTotalLOC(MetricContext) method test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 5/30/15 3:48 PM
        ...
        throws Exception
    {
        ...
        Measure<Double> result = CSharpLOC.getTotalLOC(metctx);

        // TODO: add additional test code here
        assertNotNull(result);
        assertEquals(null, result.getVariation5());
        assertEquals("quamoco.cs.LoC", result.getMetricKey());
    ...
    {
        new org.junit.runner.JUnitCore().run(CSharpLOCTest.class);
    }
}