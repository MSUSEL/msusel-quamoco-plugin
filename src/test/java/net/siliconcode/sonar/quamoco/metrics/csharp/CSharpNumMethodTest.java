...
/**
 * The class <code>CSharpNumMethodTest</code> contains tests for the class <code>{@link CSharpNumMethod}</code>.
 *
 * @generatedBy CodePro at 5/30/15 3:48 PM
 * @author isaac
 * @version $Revision: 1.0 $
 */
public class CSharpNumMethodTest {
    /**
     * Run the Measure<Double> getTotalNOM(MetricContext) method test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 5/30/15 3:48 PM
        ...
        throws Exception
    {
        ...
        Measure<Double> result = CSharpNumMethod.getTotalNOM(metctx);
    ...
    {
        new org.junit.runner.JUnitCore().run(CSharpNumMethodTest.class);
    }
}