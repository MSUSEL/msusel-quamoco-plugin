...
/**
 * The class <code>CSharpNumClassesTest</code> contains tests for the class <code>{@link CSharpNumClasses}</code>.
 *
 * @generatedBy CodePro at 5/30/15 3:48 PM
 * @author isaac
 * @version $Revision: 1.0 $
 */
public class CSharpNumClassesTest {
    /**
     * Run the Measure<Double> getTotalNOC(MetricContext) method test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 5/30/15 3:48 PM
        ...
        throws Exception
    {
        ...
        Measure<Double> result = CSharpNumClasses.getTotalNOC(metctx);

        // TODO: add additional test code here
        assertNotNull(result);
        assertEquals(null, result.getVariation5());
        assertEquals("quamoco.cs.file/CountDeclClass", result.getMetricKey());
    ...
    {
        new org.junit.runner.JUnitCore().run(CSharpNumClassesTest.class);
    }
}